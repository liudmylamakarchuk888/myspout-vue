...
const name = 'solution-designer' // TODO: get this variable from setting.ts

module.exports = {
  publicPath:
    process.env.NODE_ENV === 'production' ? '/solution-designer/' : '/',
  ...
  devServer: {
    ...
    proxy: {
      ...
      [process.env.VUE_APP_BASE_API]: {
        ...
        /// target: `http://52.152.148.181:3000/api/`,
