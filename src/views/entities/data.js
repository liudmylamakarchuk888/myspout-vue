...
export const _teams = {
  description: '',
  displayName: 'Team',
  displayNameLanguageKey: 'TEAM_ENTITY_DISPLAY_NAME',
  descriptionLanguageKey: 'TEAM_ENTITY_DESCRIPTION',
  ...
  dateCreated: 1336281114487,
  dateModified: 1569323998387,
  defaultColumns: [
    {
      key: 'ID',
      value: [
        {
          key: 'tbl',
          value: 'com.msp.dao.entities.Team'
        },
        {
          key: 'id',
          value: null
    ...
    },
    {
      ...
      value: [
        ...
        {
          key: 'section',
          value: 'com.msp.dao.entities.Section'
        }
      ]
    },
    {
      ...
      value: [
        ...
        {
          key: 'department',
          value: 'com.msp.dao.entities.Department'
        }
      ]
    }
  ],
  ...
  discipline: {
    key: 'ENTITY_DISCIPLINE_ENTITY_DISCIPLINE_USERS_AND_ORGANIZATION_SYSTEM_NAME_CHOICE_OPTION_DISPLAY_NAME',
    value: '122'
  },
  entityRelationship: null,
  lookupDefaultNameFormat: {
    parts: [
      [
        {
          key: 'tbl',
  ...
  properties: [
    {
      description: '',
      displayName: 'Allowed Portfolios',
      displayNameLanguageKey: 'TEAM_ALLOWEDPORTFOLIOS_PROPERTY_DISPLAY_NAME',
      descriptionLanguageKey: 'TEAM_ALLOWEDPORTFOLIOS_PROPERTY_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'פורטפוליו מורשים',
          language: 'he'
        }
      ],
      notes: '',
      systemName: 'allowedPortfolios',
      customLink: null,
      dataType: {
        key: 'Multi Lookup of Portfolio',
        value: '11',
        lookupClassName: 'com.msp.dao.entities.Portfolio'
      },
      entityId: 'com.msp.dao.entities.Team',
      valueChangedNotification: null,
      tabularReportsCategory: null,
      databaseColumnName: 'refTeamid',
      outOfTheBox: true,
      translated: false,
      ...
      table: 'refTeamsPortfolios',
      usingVanillaReference: false,
      referenceColumn: 'refPortfolioid'
    },
    {
      description: '',
      displayName: 'Category',
      displayNameLanguageKey: 'TEAM_ENTITYCATEGORY_PROPERTY_DISPLAY_NAME',
      descriptionLanguageKey: 'TEAM_ENTITYCATEGORY_PROPERTY_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'קטגוריה',
    ...
    },
    {
      ...
      displayNameLanguageKey: 'TEAM_DEFAULTPORTFOLIO_PROPERTY_DISPLAY_NAME',
      descriptionLanguageKey: 'TEAM_DEFAULTPORTFOLIO_PROPERTY_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'פורטפוליו ב"מ',
          language: 'he'
        }
      ],
      notes: '',
      systemName: 'defaultPortfolio',
      customLink: null,
      dataType: {
        key: 'Lookup To Portfolio',
        value: '9',
        lookupClassName: 'com.msp.dao.entities.Portfolio'
      },
      entityId: 'com.msp.dao.entities.Team',
      valueChangedNotification: null,
      tabularReportsCategory: null,
      databaseColumnName: 'refDefaultPortfolioid',
      outOfTheBox: true,
      translated: false,
      excludePropertyFromReportGenerator: false,
      excludePropertyFromEventsGenerator: false,
    ...
    },
    {
      ...
      displayNameLanguageKey: 'TEAM_DEPARTMENT_PROPERTY_DISPLAY_NAME',
      descriptionLanguageKey: 'TEAM_DEPARTMENT_PROPERTY_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'מחלקה',
      ...
      customLink: null,
      dataType: {
        key: 'Lookup To Department',
        value: '9',
        lookupClassName: 'com.msp.dao.entities.Department'
      },
      entityId: 'com.msp.dao.entities.Team',
      valueChangedNotification: null,
      tabularReportsCategory: null,
      databaseColumnName: 'refDepartmentid',
      outOfTheBox: true,
      translated: false,
      excludePropertyFromReportGenerator: false,
      excludePropertyFromEventsGenerator: false,
    ...
    },
    {
      ...
      displayNameLanguageKey: 'TEAM_EXTERNALREFERENCEID_PROPERTY_DISPLAY_NAME',
      descriptionLanguageKey: 'TEAM_EXTERNALREFERENCEID_PROPERTY_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
      ...
      notes: '',
      systemName: 'externalReferenceid',
      customLink: null,
      dataType: {
        key: 'Single Line of Text',
        value: '1'
      ...
      valueChangedNotification: null,
      tabularReportsCategory: null,
      databaseColumnName: 'ExternalReferenceid',
      outOfTheBox: true,
      translated: false,
      excludePropertyFromReportGenerator: false,
      excludePropertyFromEventsGenerator: false,
      defaultWidth: 100,
      databaseColumnType: 'varchar (150)',
      sql: null,
      formula: false,
      identity: null,
      virtualProperty: false,
    ...
    },
    {
      description: '',
      displayName: 'ID',
      displayNameLanguageKey: 'TEAM_ID_PROPERTY_DISPLAY_NAME',
      descriptionLanguageKey: 'TEAM_ID_PROPERTY_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'מזהה',
    ...
    },
    {
      description: '',
      displayName: 'Manager',
      displayNameLanguageKey: 'TEAM_MANAGER_PROPERTY_DISPLAY_NAME',
      descriptionLanguageKey: 'TEAM_MANAGER_PROPERTY_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'מנהל',
      ...
      valueChangedNotification: null,
      tabularReportsCategory: null,
      databaseColumnName: 'refManagerid',
      outOfTheBox: true,
      translated: false,
      excludePropertyFromReportGenerator: false,
      excludePropertyFromEventsGenerator: false,
    ...
    },
    {
      description: '',
      displayName: 'Name',
      displayNameLanguageKey: 'TEAM_NAME_PROPERTY_DISPLAY_NAME',
      descriptionLanguageKey: 'TEAM_NAME_PROPERTY_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'שם',
    ...
    },
    {
      ...
      displayNameLanguageKey: 'TEAM_PRIMARYCONTACT_PROPERTY_DISPLAY_NAME',
      descriptionLanguageKey: 'TEAM_PRIMARYCONTACT_PROPERTY_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'איש קשר ראשי',
          language: 'he'
        }
      ],
      notes: '',
      ...
      valueChangedNotification: null,
      tabularReportsCategory: null,
      databaseColumnName: 'refPrimaryContactid',
      outOfTheBox: true,
      translated: false,
      excludePropertyFromReportGenerator: false,
      excludePropertyFromEventsGenerator: false,
    ...
    },
    {
      description: '',
      displayName: 'Section',
      displayNameLanguageKey: 'TEAM_SECTION_PROPERTY_DISPLAY_NAME',
      descriptionLanguageKey: 'TEAM_SECTION_PROPERTY_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'תחום',
      ...
      customLink: null,
      dataType: {
        key: 'Lookup To Section',
        value: '9',
        lookupClassName: 'com.msp.dao.entities.Section'
      },
      entityId: 'com.msp.dao.entities.Team',
      valueChangedNotification: null,
      tabularReportsCategory: null,
      databaseColumnName: 'refSectionid',
      outOfTheBox: true,
      translated: false,
      excludePropertyFromReportGenerator: false,
      excludePropertyFromEventsGenerator: false,
    ...
    },
    {
      description: '',
      displayName: 'State',
      displayNameLanguageKey: 'TEAM_STATE_PROPERTY_DISPLAY_NAME',
      descriptionLanguageKey: 'TEAM_STATE_PROPERTY_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
    ...
    },
    {
      ...
      displayNameLanguageKey: 'TEAM_TIMECREATED_PROPERTY_DISPLAY_NAME',
      descriptionLanguageKey: 'TEAM_TIMECREATED_PROPERTY_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
    ...
    },
    {
      ...
      displayNameLanguageKey: 'TEAM_TIMEUPDATED_PROPERTY_DISPLAY_NAME',
      descriptionLanguageKey: 'TEAM_TIMEUPDATED_PROPERTY_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
    ...
    },
    {
      description: '',
      displayName: 'Users',
      displayNameLanguageKey: 'TEAM_USERS_PROPERTY_DISPLAY_NAME',
      descriptionLanguageKey: 'TEAM_USERS_PROPERTY_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'משתמשים',
  ...
  milestonesTableProperty: '',
  milestonesTableDueDateProperty: '',
  milestonesTableStatusProperty: '',
  milestonesTableStatusDeliverableStatusProperty: '',
  milestonesTableDescriptionProperty: '',
  milestonesTableOwnerProperty: null,
  activityOwnerProperty: '',
  goalsProperty: '',
  enableForExecutionCenter: false,
  allowCreatingReport: false,
  canChangeAttachmentSupport: true,
  canChangeFollowersSupport: true,
  canChangeIntegrationSupport: true,
  creationPolicyType: 3,
  createUrl: 'generated_create.jsp?entityCategoryId=$entityCategory.id',
  databaseTableName: 'Teams',
  defaultUrl: 'generated_edit.jsp?entityCategoryId=$entityCategory.id&id=$id&current_tab_object=@@CURRENT_TAB_OBJECT@@',
  deleted: false,
  editUrl: 'generated_edit.jsp?entityCategoryId=$entityCategory.id&id=$id&current_tab_object=@@CURRENT_TAB_OBJECT@@',
  icon: 'organizational-unit-16x16.png',
  id: 'com.msp.dao.entities.Team',
  listUrl: 'generated_manage_entity.jsp?entityCategoryId=$entityCategory.id',
  managementPolicy: 0,
  managementGenericURL: null,
  newInstance: false,
  outOfTheBox: true,
  supportAttachments: false,
  supportIntegration: false,
  appearInRecentVisit: false,
  primaryNamePropertySystemName: 'name',
  cfgItemUniquePropertySystemName: null,
  ...
  virtual: false,
  supportFormConfiguration: true,
  entityName: 'Team',
  itemType: 1
}
export const _properties = // 20200923174415
// http://52.152.148.181:3000/api/getEntity/com.msp.dao.entities.Team
...
export const _riskProperties =// 20200923175327
// http://52.152.148.181:3000/api/getEntity/com.msp.dao.entities.Risk

{
  description: '',
  displayName: 'Risk',
  displayNameLanguageKey: 'RISK_ENTITY_DISPLAY_NAME',
  descriptionLanguageKey: 'RISK_ENTITY_DESCRIPTION',
  languageTranslations: [
    {
      description: '',
      displayName: 'סיכון',
  ...
  defaultColumns: [
    {
      ...
      value: [
        {
          key: 'tbl',
          value: 'com.msp.dao.entities.Risk'
        },
        {
          key: 'id',
          value: null
    ...
    },
    {
      ...
      value: [
        ...
        {
          key: 'severity',
          value: 'com.msp.dao.entities.RiskSeverity'
        }
      ]
    },
    {
      ...
      value: [
        ...
        {
          key: 'probability',
          value: 'com.msp.dao.entities.RiskProbability'
        }
      ]
    },
    {
    ...
    {
      key: 'RISK_STATUS_PROPERTY_DISPLAY_NAME',
      value: [
        {
          key: 'tbl',
          value: 'com.msp.dao.entities.Risk'
        ...
        {
          key: 'status',
          value: 'com.msp.dao.entities.Status'
        }
      ]
    }
  ],
  deleteNotification: null,
  discipline: {
    key: 'ENTITY_DISCIPLINE_ENTITY_DISCIPLINE_RISK_SYSTEM_NAME_CHOICE_OPTION_DISPLAY_NAME',
    value: '26'
  },
  entityRelationship: null,
  lookupDefaultNameFormat: {
  ...
  properties: [
    {
      ...
      displayNameLanguageKey: 'RISK_ASSIGNEEUSER_PROPERTY_DISPLAY_NAME',
      descriptionLanguageKey: 'RISK_ASSIGNEEUSER_PROPERTY_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
      ...
      valueChangedNotification: null,
      tabularReportsCategory: null,
      databaseColumnName: 'refAssigneeUserid',
      outOfTheBox: true,
      translated: false,
      excludePropertyFromReportGenerator: false,
      excludePropertyFromEventsGenerator: false,
    ...
    },
    {
      ...
      displayNameLanguageKey: 'RISK_ATTACHMENTS_PROPERTY_DISPLAY_NAME',
      descriptionLanguageKey: 'RISK_ATTACHMENTS_PROPERTY_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'מסמכים',
    ...
    },
    {
      description: '',
      displayName: 'Category',
      displayNameLanguageKey: 'RISK_CATEGORY_PROPERTY_DISPLAY_NAME',
      descriptionLanguageKey: 'RISK_CATEGORY_PROPERTY_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'קטגוריה',
      ...
      customLink: null,
      dataType: {
        key: 'Lookup To Risk Category',
        value: '9',
        lookupClassName: 'com.msp.dao.entities.RiskCategory'
      },
      entityId: 'com.msp.dao.entities.Risk',
      valueChangedNotification: null,
      tabularReportsCategory: null,
      databaseColumnName: 'refRiskCategoryid',
      outOfTheBox: true,
      translated: false,
      excludePropertyFromReportGenerator: false,
      excludePropertyFromEventsGenerator: false,
    ...
    {
      description: '',
      displayName: 'Checkpoint Date',
      displayNameLanguageKey: 'RISK_CHECKPOINTDATE_PROPERTY_DISPLAY_NAME',
      descriptionLanguageKey: 'RISK_CHECKPOINTDATE_PROPERTY_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'תאריך בקרה',
          language: 'he'
        }
      ],
      notes: '',
      systemName: 'checkPointDate',
      customLink: null,
      dataType: {
        key: 'Date and Time',
        value: '4'
      ...
      valueChangedNotification: null,
      tabularReportsCategory: null,
      databaseColumnName: 'CheckPointDate',
      outOfTheBox: true,
      translated: false,
      excludePropertyFromReportGenerator: false,
      excludePropertyFromEventsGenerator: false,
    ...
    },
    {
      ...
      displayNameLanguageKey: 'RISK_CONSEQUENCES_PROPERTY_DISPLAY_NAME',
      descriptionLanguageKey: 'RISK_CONSEQUENCES_PROPERTY_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'השלכות',
      ...
      valueChangedNotification: null,
      tabularReportsCategory: null,
      databaseColumnName: 'Consequences',
      outOfTheBox: true,
      translated: false,
      excludePropertyFromReportGenerator: false,
      excludePropertyFromEventsGenerator: false,
    ...
    },
    {
      ...
      displayNameLanguageKey: 'RISK_CREATIONUSER_PROPERTY_DISPLAY_NAME',
      descriptionLanguageKey: 'RISK_CREATIONUSER_PROPERTY_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'נוצר על-ידי',
          language: 'he'
        }
      ],
      notes: '',
    ...
    {
      description: '',
      displayName: 'Current Step Description',
      displayNameLanguageKey: 'RISK_CURRENTSTEPDESCRIPTION_PROPERTY_DISPLAY_NAME',
      descriptionLanguageKey: 'RISK_CURRENTSTEPDESCRIPTION_PROPERTY_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'תיאור השלב הנוכחי',
          language: 'he'
        }
      ],
      notes: '',
      systemName: 'currentStepDescription',
      customLink: null,
      dataType: {
        key: 'Single Line of Text',
        value: '1'
      ...
      valueChangedNotification: null,
      tabularReportsCategory: null,
      databaseColumnName: 'CurrentStepDescription',
      outOfTheBox: true,
      translated: true,
      excludePropertyFromReportGenerator: false,
      excludePropertyFromEventsGenerator: false,
    ...
    },
    {
      ...
      displayNameLanguageKey: 'RISK_CURRENTSTEPID_PROPERTY_DISPLAY_NAME',
      descriptionLanguageKey: 'RISK_CURRENTSTEPID_PROPERTY_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'שלב נוכחי',
          language: 'he'
        }
      ],
      notes: '',
      systemName: 'currentStepId',
      customLink: null,
      dataType: {
        key: 'Single Line of Text',
        value: '1'
      ...
      valueChangedNotification: null,
      tabularReportsCategory: null,
      databaseColumnName: 'CurrentStepId',
      outOfTheBox: true,
      translated: false,
      excludePropertyFromReportGenerator: false,
      excludePropertyFromEventsGenerator: false,
    ...
    },
    {
      ...
      displayNameLanguageKey: 'RISK_DESCRIPTION_PROPERTY_DISPLAY_NAME',
      descriptionLanguageKey: 'RISK_DESCRIPTION_PROPERTY_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'תיאור',
      ...
      excludePropertyFromEventsGenerator: false,
      defaultWidth: 100,
      databaseColumnType: 'varchar (1000)',
      sql: null,
      formula: false,
      identity: null,
      virtualProperty: false,
    ...
    },
    {
      ...
      displayNameLanguageKey: 'RISK_ENTITYCATEGORY_PROPERTY_DISPLAY_NAME',
      descriptionLanguageKey: 'RISK_ENTITYCATEGORY_PROPERTY_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'קטגוריה',
    ...
    },
    {
      description: '',
      displayName: 'External Reference ID',
      displayNameLanguageKey: 'RISK_EXTERNALREFERENCEID_PROPERTY_DISPLAY_NAME',
      descriptionLanguageKey: 'RISK_EXTERNALREFERENCEID_PROPERTY_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'מזהה חיצוני',
    ...
    },
    {
      description: '',
      displayName: 'ID',
      displayNameLanguageKey: 'RISK_ID_PROPERTY_DISPLAY_NAME',
      descriptionLanguageKey: 'RISK_ID_PROPERTY_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'מזהה',
    ...
    },
    {
      description: '',
      displayName: 'Impact',
      displayNameLanguageKey: 'RISK_IMPACT_PROPERTY_DISPLAY_NAME',
      descriptionLanguageKey: 'RISK_IMPACT_PROPERTY_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'השפעה',
    ...
    },
    {
      ...
      displayNameLanguageKey: 'RISK_INDEXPOSITION_PROPERTY_DISPLAY_NAME',
      descriptionLanguageKey: 'RISK_INDEXPOSITION_PROPERTY_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'מיקום',
    ...
    },
    {
      ...
      displayNameLanguageKey: 'RISK_INTEGRATIONFLAG_PROPERTY_DISPLAY_NAME',
      descriptionLanguageKey: 'RISK_INTEGRATIONFLAG_PROPERTY_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'דגל אינטגרציה',
          language: 'he'
        }
      ],
      notes: '',
      systemName: 'integrationFlag',
      customLink: null,
      dataType: {
        key: 'Choice',
        value: '3',
        options: [
          {
            description: '',
            displayName: 'Success',
            displayNameLanguageKey: 'RISK_INTEGRATIONFLAG_INTEGRATIONSUCCESS_CHOICE_OPTION_DISPLAY_NAME',
            descriptionLanguageKey: 'RISK_INTEGRATIONFLAG_INTEGRATIONSUCCESS_CHOICE_OPTION_DESCRIPTION',
            languageTranslations: [
              {
                description: '',
                displayName: 'Success',
            ...
            notes: '',
            systemName: 'integrationSuccess'
          },
          {
            description: '',
            displayName: 'Warning',
            displayNameLanguageKey: 'RISK_INTEGRATIONFLAG_INTEGRATIONWARNING_CHOICE_OPTION_DISPLAY_NAME',
            descriptionLanguageKey: 'RISK_INTEGRATIONFLAG_INTEGRATIONWARNING_CHOICE_OPTION_DESCRIPTION',
            languageTranslations: [
              {
                description: '',
                displayName: 'Warning',
            ...
            notes: '',
            systemName: 'integrationWarning'
          },
          {
            description: '',
            displayName: 'Failed',
            displayNameLanguageKey: 'RISK_INTEGRATIONFLAG_INTEGRATIONFAILED_CHOICE_OPTION_DISPLAY_NAME',
            descriptionLanguageKey: 'RISK_INTEGRATIONFLAG_INTEGRATIONFAILED_CHOICE_OPTION_DESCRIPTION',
            languageTranslations: [
              {
                description: '',
                displayName: 'Failed',
      ...
      valueChangedNotification: null,
      tabularReportsCategory: null,
      databaseColumnName: 'refIntegrationFlagid',
      outOfTheBox: true,
      translated: false,
      excludePropertyFromReportGenerator: false,
      excludePropertyFromEventsGenerator: false,
    ...
    },
    {
      ...
      displayNameLanguageKey: 'RISK_INTEGRATIONOPERATIONS_PROPERTY_DISPLAY_NAME',
      descriptionLanguageKey: 'RISK_INTEGRATIONOPERATIONS_PROPERTY_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'פעולות אינטגרציה ברמת המופע',
          language: 'he'
        }
      ],
      notes: '',
      systemName: 'integrationOperations',
      customLink: null,
      dataType: {
        key: 'Table of Instance Level Integration Operation',
        value: '10',
        lookupClassName: 'com.msp.dao.entities.InstanceLevelIntegrationOperation'
      },
      entityId: 'com.msp.dao.entities.Risk',
      valueChangedNotification: null,
      tabularReportsCategory: null,
      ...
      filter: null,
      orderByColumnName: null,
      table: 'InstanceLevelIntegrationOperations',
      usingVanillaReference: false
    },
    {
      description: '',
      displayName: 'Last Time Status Changed',
      displayNameLanguageKey: 'RISK_LASTTIMESTATUSCHANGED_PROPERTY_DISPLAY_NAME',
      descriptionLanguageKey: 'RISK_LASTTIMESTATUSCHANGED_PROPERTY_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'תאריך שינוי סטטוס אחרון',
          language: 'he'
        }
      ],
      notes: '',
      systemName: 'lastTimeStatusChanged',
      customLink: null,
      dataType: {
        key: 'Date and Time',
        value: '4'
      ...
      valueChangedNotification: null,
      tabularReportsCategory: null,
      databaseColumnName: 'LastTimeStatusChanged',
      outOfTheBox: true,
      translated: false,
      excludePropertyFromReportGenerator: false,
      excludePropertyFromEventsGenerator: false,
    ...
    },
    {
      ...
      displayNameLanguageKey: 'RISK_MITIGATION_PROPERTY_DISPLAY_NAME',
      descriptionLanguageKey: 'RISK_MITIGATION_PROPERTY_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'פעולת תיקון',
          language: 'he'
        }
      ],
      notes: '',
    ...
    {
      description: '',
      displayName: 'Monetary Impact',
      displayNameLanguageKey: 'RISK_IMPACTMONEY_PROPERTY_DISPLAY_NAME',
      descriptionLanguageKey: 'RISK_IMPACTMONEY_PROPERTY_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'השלכה כספית',
          language: 'he'
        }
      ],
      notes: '',
      systemName: 'impactMoney',
      customLink: null,
      dataType: {
        key: 'Number with Decimal Point',
        value: '8'
      ...
      valueChangedNotification: null,
      tabularReportsCategory: null,
      databaseColumnName: 'ImpactMoney',
      outOfTheBox: true,
      translated: false,
      excludePropertyFromReportGenerator: false,
      excludePropertyFromEventsGenerator: false,
    ...
    },
    {
      description: '',
      displayName: 'Name',
      displayNameLanguageKey: 'RISK_NAME_PROPERTY_DISPLAY_NAME',
      descriptionLanguageKey: 'RISK_NAME_PROPERTY_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'שם',
    ...
    },
    {
      description: '',
      displayName: 'Owner',
      displayNameLanguageKey: 'RISK_OWNER_PROPERTY_DISPLAY_NAME',
      descriptionLanguageKey: 'RISK_OWNER_PROPERTY_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'אחראי',
    ...
    {
      description: '',
      displayName: 'Previous Flow Step Description',
      displayNameLanguageKey: 'RISK_PREVIOUSFLOWSTEPDESCRIPTION_PROPERTY_DISPLAY_NAME',
      descriptionLanguageKey: 'RISK_PREVIOUSFLOWSTEPDESCRIPTION_PROPERTY_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'תיאור שלב מחזור חיים ראשי קודם',
          language: 'he'
        }
      ],
      notes: '',
      systemName: 'previousFlowStepDescription',
      customLink: null,
      dataType: {
        key: 'Single Line of Text',
        value: '1'
      ...
      valueChangedNotification: null,
      tabularReportsCategory: null,
      databaseColumnName: 'PreviousFlowStepDescription',
      outOfTheBox: true,
      translated: true,
      excludePropertyFromReportGenerator: false,
      excludePropertyFromEventsGenerator: false,
    ...
    {
      description: '',
      displayName: 'Previous Flow Step ID',
      displayNameLanguageKey: 'RISK_PREVIOUSFLOWSTEPID_PROPERTY_DISPLAY_NAME',
      descriptionLanguageKey: 'RISK_PREVIOUSFLOWSTEPID_PROPERTY_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'מזהה שלב מחזור חיים ראשי קודם',
          language: 'he'
        }
      ],
      notes: '',
      systemName: 'previousFlowStepId',
      customLink: null,
      dataType: {
        key: 'Single Line of Text',
        value: '1'
      ...
      valueChangedNotification: null,
      tabularReportsCategory: null,
      databaseColumnName: 'PreviousFlowStepId',
      outOfTheBox: true,
      translated: false,
      excludePropertyFromReportGenerator: false,
      excludePropertyFromEventsGenerator: false,
    ...
    },
    {
      ...
      displayNameLanguageKey: 'RISK_PREVIOUSSTATUS_PROPERTY_DISPLAY_NAME',
      descriptionLanguageKey: 'RISK_PREVIOUSSTATUS_PROPERTY_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'סטטוס קודם',
          language: 'he'
        }
      ],
      notes: '',
      systemName: 'previousStatus',
      customLink: null,
      dataType: {
        key: 'Lookup To Status',
        value: '9',
        lookupClassName: 'com.msp.dao.entities.Status'
      },
      entityId: 'com.msp.dao.entities.Risk',
      valueChangedNotification: null,
      tabularReportsCategory: null,
      databaseColumnName: 'refPreviousStatusid',
      outOfTheBox: true,
      translated: false,
      excludePropertyFromReportGenerator: false,
      excludePropertyFromEventsGenerator: false,
    ...
    },
    {
      ...
      displayNameLanguageKey: 'RISK_PREVIOUSSTEPID_PROPERTY_DISPLAY_NAME',
      descriptionLanguageKey: 'RISK_PREVIOUSSTEPID_PROPERTY_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'השלב הקודם',
          language: 'he'
        }
      ],
      notes: '',
      systemName: 'previousStepId',
      customLink: null,
      dataType: {
        key: 'Single Line of Text',
        value: '1'
      ...
      valueChangedNotification: null,
      tabularReportsCategory: null,
      databaseColumnName: 'PreviousStepId',
      outOfTheBox: true,
      translated: false,
      excludePropertyFromReportGenerator: false,
      excludePropertyFromEventsGenerator: false,
    ...
    {
      description: '',
      displayName: 'Previous Step Description',
      displayNameLanguageKey: 'RISK_PREVIOUSSTEPDESCRIPTION_PROPERTY_DISPLAY_NAME',
      descriptionLanguageKey: 'RISK_PREVIOUSSTEPDESCRIPTION_PROPERTY_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'תיאור שלב קודם',
          language: 'he'
        }
      ],
      notes: '',
      systemName: 'previousStepDescription',
      customLink: null,
      dataType: {
        key: 'Single Line of Text',
        value: '1'
      ...
      valueChangedNotification: null,
      tabularReportsCategory: null,
      databaseColumnName: 'PreviousStepDescription',
      outOfTheBox: true,
      translated: true,
      excludePropertyFromReportGenerator: false,
      excludePropertyFromEventsGenerator: false,
    ...
    },
    {
      ...
      displayNameLanguageKey: 'RISK_PROBABILITY_PROPERTY_DISPLAY_NAME',
      descriptionLanguageKey: 'RISK_PROBABILITY_PROPERTY_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'הסתברות',
      ...
      notes: '',
      systemName: 'probability',
      customLink: null,
      dataType: {
        key: 'Lookup To Risk Probability',
        value: '9',
        lookupClassName: 'com.msp.dao.entities.RiskProbability'
      },
      entityId: 'com.msp.dao.entities.Risk',
      valueChangedNotification: null,
      tabularReportsCategory: null,
      databaseColumnName: 'refRiskProbabilityid',
      outOfTheBox: true,
      translated: false,
      excludePropertyFromReportGenerator: false,
      excludePropertyFromEventsGenerator: false,
    ...
    },
    {
      ...
      displayNameLanguageKey: 'RISK_RECIPIENTS_PROPERTY_DISPLAY_NAME',
      descriptionLanguageKey: 'RISK_RECIPIENTS_PROPERTY_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'נמענים',
      ...
      filter: null,
      orderByColumnName: null,
      table: 'refObjectsRecipients',
      usingVanillaReference: false,
      referenceColumn: 'refUserid'
    },
    {
      description: '',
      displayName: 'Release',
      displayNameLanguageKey: 'RISK_RELEASE_PROPERTY_DISPLAY_NAME',
      descriptionLanguageKey: 'RISK_RELEASE_PROPERTY_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'גרסא',
      ...
      customLink: null,
      dataType: {
        key: 'Lookup To Release',
        value: '9',
        lookupClassName: 'com.msp.dao.entities.Release'
      },
      entityId: 'com.msp.dao.entities.Risk',
      valueChangedNotification: null,
      tabularReportsCategory: null,
      databaseColumnName: 'refReleaseid',
      outOfTheBox: true,
      translated: false,
      excludePropertyFromReportGenerator: false,
      excludePropertyFromEventsGenerator: false,
    ...
    },
    {
      description: '',
      displayName: 'Remark',
      displayNameLanguageKey: 'RISK_REMARK_PROPERTY_DISPLAY_NAME',
      descriptionLanguageKey: 'RISK_REMARK_PROPERTY_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'הערות',
    ...
    },
    {
      ...
      displayNameLanguageKey: 'RISK_REQUIREMENT_PROPERTY_DISPLAY_NAME',
      descriptionLanguageKey: 'RISK_REQUIREMENT_PROPERTY_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'דרישה',
      ...
      notes: '',
      systemName: 'requirement',
      customLink: null,
      dataType: {
        key: 'Lookup To Requirement',
        value: '9',
        lookupClassName: 'com.msp.dao.entities.Requirement'
      },
      entityId: 'com.msp.dao.entities.Risk',
      valueChangedNotification: null,
      tabularReportsCategory: null,
      databaseColumnName: 'refRequirementid',
      outOfTheBox: true,
      translated: false,
      excludePropertyFromReportGenerator: false,
      excludePropertyFromEventsGenerator: false,
    ...
    },
    {
      ...
      displayNameLanguageKey: 'RISK_SEVERITY_PROPERTY_DISPLAY_NAME',
      descriptionLanguageKey: 'RISK_SEVERITY_PROPERTY_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'רמת חומרה',
          language: 'he'
        }
      ],
      notes: '',
      ...
      customLink: null,
      dataType: {
        key: 'Lookup To Risk Severity',
        value: '9',
        lookupClassName: 'com.msp.dao.entities.RiskSeverity'
      },
      entityId: 'com.msp.dao.entities.Risk',
      valueChangedNotification: null,
      tabularReportsCategory: null,
      databaseColumnName: 'refRiskSeverityid',
      outOfTheBox: true,
      translated: false,
      excludePropertyFromReportGenerator: false,
      excludePropertyFromEventsGenerator: false,
    ...
    },
    {
      description: '',
      displayName: 'State',
      displayNameLanguageKey: 'RISK_STATE_PROPERTY_DISPLAY_NAME',
      descriptionLanguageKey: 'RISK_STATE_PROPERTY_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'מצב רשומה',
    ...
    },
    {
      description: '',
      displayName: 'Status',
      displayNameLanguageKey: 'RISK_STATUS_PROPERTY_DISPLAY_NAME',
      descriptionLanguageKey: 'RISK_STATUS_PROPERTY_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'סטטוס',
      ...
      valueChangedNotification: null,
      tabularReportsCategory: null,
      databaseColumnName: 'refStatusid',
      outOfTheBox: true,
      translated: false,
      excludePropertyFromReportGenerator: false,
      excludePropertyFromEventsGenerator: false,
    ...
    {
      description: '',
      displayName: 'Status Free Text',
      displayNameLanguageKey: 'RISK_FREETEXTSTATUS_PROPERTY_DISPLAY_NAME',
      descriptionLanguageKey: 'RISK_FREETEXTSTATUS_PROPERTY_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'סטטוס טקסט חופשי',
          language: 'he'
        }
      ],
      notes: '',
      systemName: 'freeTextStatus',
      customLink: null,
      dataType: {
        key: 'Textarea',
        value: '2'
      ...
      valueChangedNotification: null,
      tabularReportsCategory: null,
      databaseColumnName: 'FreeTextStatus',
      outOfTheBox: true,
      translated: false,
      excludePropertyFromReportGenerator: false,
      excludePropertyFromEventsGenerator: false,
    ...
    },
    {
      description: '',
      displayName: 'Time Created',
      displayNameLanguageKey: 'RISK_TIMECREATED_PROPERTY_DISPLAY_NAME',
      descriptionLanguageKey: 'RISK_TIMECREATED_PROPERTY_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'זמן יצירה',
    ...
    },
    {
      description: '',
      displayName: 'Time Updated',
      displayNameLanguageKey: 'RISK_TIMEUPDATED_PROPERTY_DISPLAY_NAME',
      descriptionLanguageKey: 'RISK_TIMEUPDATED_PROPERTY_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'תאריך עדכון',
    ...
    },
    {
      description: '',
      displayName: 'Total',
      displayNameLanguageKey: 'RISK_TOTAL_PROPERTY_DISPLAY_NAME',
      descriptionLanguageKey: 'RISK_TOTAL_PROPERTY_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'סה"כ',
    ...
    },
    {
      description: '',
      displayName: 'Weight',
      displayNameLanguageKey: 'RISK_WEIGHT_PROPERTY_DISPLAY_NAME',
      descriptionLanguageKey: 'RISK_WEIGHT_PROPERTY_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'משקל',
  ...
  status: [
    {
      description: '',
      displayName: 'New',
      displayNameLanguageKey: 'RISK_NEW_STATUS_DISPLAY_NAME',
      descriptionLanguageKey: 'RISK_NEW_STATUS_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'New',
    ...
    },
    {
      ...
      displayNameLanguageKey: 'RISK_APPROVED_STATUS_DISPLAY_NAME',
      descriptionLanguageKey: 'RISK_APPROVED_STATUS_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'Approved',
    ...
    },
    {
      ...
      displayNameLanguageKey: 'RISK_REJECTED_STATUS_DISPLAY_NAME',
      descriptionLanguageKey: 'RISK_REJECTED_STATUS_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'Rejected',
    ...
    },
    {
      description: '',
      displayName: 'Closed',
      displayNameLanguageKey: 'RISK_CLOSED_STATUS_DISPLAY_NAME',
      descriptionLanguageKey: 'RISK_CLOSED_STATUS_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'Closed',
    ...
    },
    {
      description: '',
      displayName: 'Draft',
      displayNameLanguageKey: 'RISK_DRAFT_STATUS_DISPLAY_NAME',
      descriptionLanguageKey: 'RISK_DRAFT_STATUS_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'Draft',
    ...
    },
    {
      ...
      displayNameLanguageKey: 'RISK_CANCELLED_STATUS_DISPLAY_NAME',
      descriptionLanguageKey: 'RISK_CANCELLED_STATUS_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'Cancelled',
    ...
    },
    {
      ...
      displayNameLanguageKey: 'RISK_MATERIALIZED_STATUS_DISPLAY_NAME',
      descriptionLanguageKey: 'RISK_MATERIALIZED_STATUS_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'Materialized',
    ...
    },
    {
      ...
      displayNameLanguageKey: 'RISK_PRELIMINARY_STATUS_DISPLAY_NAME',
      descriptionLanguageKey: 'RISK_PRELIMINARY_STATUS_DESCRIPTION',
      languageTranslations: [
        {
          description: '',
          displayName: 'Preliminary',
      ...
      notes: '',
      systemName: 'RISK_PRELIMINARY',
      outOfTheBox: true,
      setState: 1
    }
  ],
  milestonesTableProperty: null,
  milestonesTableDueDateProperty: null,
  milestonesTableStatusProperty: null,
  milestonesTableStatusDeliverableStatusProperty: null,
  milestonesTableDescriptionProperty: null,
  milestonesTableOwnerProperty: null,
  activityOwnerProperty: null,
  goalsProperty: null,
  enableForExecutionCenter: false,
  allowCreatingReport: false,
  ...
  canChangeFollowersSupport: true,
  canChangeIntegrationSupport: true,
  creationPolicyType: 2,
  createUrl: 'generated_create.jsp?entityCategoryId=$entityCategory.id',
  databaseTableName: 'Risks',
  defaultUrl: 'generated_edit.jsp?entityCategoryId=$entityCategory.id&id=$id&current_tab_object=@@CURRENT_TAB_OBJECT@@',
  deleted: false,
  editUrl: 'generated_edit.jsp?entityCategoryId=$entityCategory.id&id=$id&current_tab_object=@@CURRENT_TAB_OBJECT@@',
  icon: null,
  ...
  supportFollowers: false,
  supportTimeTracking: false,
  supportIndexPosition: true,
  supportTree: false,
  supportWorkflowConfiguration: true,
  virtual: false,
  supportFormConfiguration: true,
  entityName: 'Risk',
  itemType: 1
}
export const _FlexApplicationPreferences = {
  baseRoles: [
    {
      key: 'Employee',
      value: '1'
  ...
  translations: [
    {
      ...
      value: [
        {
          key: 'RESERVED_DB_NAME',
          value: 'This is a reserved database column name. Type a different display name or column name'
        },
        {
          key: 'WORKFLOW_CONDITION',
          value: 'Workflow Condition'
        ...
        {
          key: 'EXPAND_THIS_SECTION_BY_DEFAULT',
          value: 'Expand this section by default if the following conditions are met'
        },
        {
          key: 'MY_WORK',
          value: 'My Work'
        ...
        {
          key: 'USE_FOLLOWING_DISPLAY_NAME_AND_TOOLTIP',
          value: 'Use the following display name and tooltip instead of the default settings'
        },
        {
          key: 'DO_YOU_WANT_TO_DELETE_THE_MORE_INFO',
          value: 'Do you want to delete the more info?'
        ...
        {
          key: 'SET_GROUPING_ORDER_WORKFLOW_BUTTONS_USING_LIST',
          value: 'Set the grouping and order of workflow buttons using the list below.'
        },
        {
          key: 'STATUS_LIST',
          value: 'Status List'
        ...
        {
          key: 'USE_THE_FOLLOWING_DISPLAY',
          value: 'Use the following display name instead of the default settings'
        },
        {
          key: 'SQL_QUERY',
          value: 'SQL Query'
        ...
        {
          key: 'ACTUAL_WORK_UNLIMITED_HELP',
          value: 'Recommended when work estimations and progress are not applicable'
        },
        {
          key: 'NO_LOOKUP_PROPERTY_FOUND',
          value: 'No lookup property found on selected entity '
        ...
        {
          key: 'NEW_SECTION_TOOLTIP',
          value: 'A section can be used to group properties together on the form'
        },
        {
          key: 'NEW_INFORMATION_GROUP',
          value: 'New Information Group'
        ...
        {
          key: 'USER_CAN_INTEGRATE_ENTITY_WITH_EXTERNAL',
          value: 'Users can integrate this entity with third party integrations (cannot be unselected)'
        },
        {
          key: 'OPEN_WEEK_DAYS',
          value: 'Open work week days for tracking'
        ...
        {
          key: 'SAVING_OR_MOVING_PROHIBITED_IF_ITEM_IN_SET_PASSES',
          value: 'Saving or moving the workflow will be prohibited if there is and item set which <br/>passes the conditions'
        },
        {
          key: 'OPEN_WORKSHEET_AFTER',
          value: 'Open worksheet after its finish date for only (days):'
        ...
        {
          key: 'CONTROL_CANT_BE_EDITED',
          value: 'The control is currently not editable. To enable editing add the "Everyone" role group.'
        },
        {
          key: 'DISPLAY_NAME_SINGULAR_INPUT_HELP',
          value: 'A new entity will be created with this name. Example: My Entity'
        },
        {
          key: 'ALL_COLUMN_PROPERTIES_TOOLTIP',
          value: 'Add properties to the selected container'
        ...
        {
          key: 'RESTRICT_EDITING_TABLE_ROWS',
          value: 'Restrict editing rows and deleting specific rows by adding conditions.'
        },
        {
          key: 'THE_BUTTON_RETURNS_THE_FLOW_TO_LAST_STEP',
          value: 'The button returns the workflow to the last flow step it was at.. Include the button for <br />steps like "Awaiting Customer Reply", "Impact Update".'
        },
        {
          key: 'DISPLAY_NAME_PLURAL_INPUT_HELP',
          value: 'A new table property will be created with this name. Example: My Entities'
        },
        {
          key: 'ENVIRONMENT_APPLICATION_PREFERENCE',
          value: 'Environment Application Preference'
        ...
        {
          key: 'RESTRICT_EDITING_TAB',
          value: 'Restrict editing this tab and its child controls by adding conditions'
        },
        {
          key: 'NO_RECENT_DOCUMENTS_EXPLANATION',
          value: 'After you create and modify documents, they will be listed here.'
        },
        {
          key: 'WORKFLOW_FILTER',
          value: 'Workflow filter'
        ...
        {
          key: 'THE_PROPERTY_IS_ALREADY_ON_THE_FORM',
          value: 'The property is already on the form. Choose a property not on the form'
        },
        {
          key: 'SIDE_STEP_PANEL_TITLE',
          value: 'Side steps'
        ...
        {
          key: 'CUSTOM_LINK_HELP_TEXT',
          value: "To include the value of the property in the URL, type @VALUE. @VALUE of lookup properties is the item's ID. The link will be enabled when the property has a value."
        },
        {
          key: 'REPORTING',
          value: 'Reporting'
        ...
        {
          key: 'TRANSITION_SETTINGS_ROLE_GROUP_DESCRIPTION',
          value: "Use role groups to check different conditions based on the logged-in user's role."
        },
        {
          key: 'DB_COL_DATA_TYPE',
          value: 'Database column data type'
        ...
        {
          key: 'ADD_CONDITION_XML_ELEMENTS_INSIDE_SERVERSTEP',
          value: 'Add [Criteria], [ActionsOnTrue] or [ActionsOnFalse] XML elements. They will automatically be placed inside a [Condition] XML element.'
        },
        {
          key: 'EVERYONE_CAN_MOVE_WORKFLOW_BECAUSE_EVERYONE_ROLE_GROUP',
          value: 'Everyone can move the workflow because the Everyone role group has no conditions.'
        },
        {
          key: 'EDIT_ROLE_GROUP',
          value: 'Edit Role Group'
        ...
        {
          key: 'REMOVE_ENTITY_TEXT',
          value: "Users won't be able to track time and progress against items of this entity. Existing tracked data will not be deleted."
        },
        {
          key: 'STATUS_CONDITION',
          value: 'Status condition'
        ...
        {
          key: 'UNIQUE_SYSTEM_NAME',
          value: 'This system name is already in use. Type a different display name or system name'
        },
        {
          key: 'DISPLAY_NAME_PLURAL',
          value: 'Display Name - Plural'
        ...
        {
          key: 'FOLDER_TITLE',
          value: 'The user will be authorized if he / she is authorized to one of the nodes in the folder.'
        },
        {
          key: 'IS_PRIOR_TO_OR_EQUAL_TO',
          value: 'Is prior to or equal to'
        ...
        {
          key: 'USER_SET_IN_APP_PREF_TITLE',
          value: 'The user will be authorized if he / she is set in an application preference.'
        },
        {
          key: 'EDIT_PROPERTY_CHANGE_CONDITION',
          value: 'Edit Property Change Condition'
        ...
        {
          key: 'USERS_CAN_CHANGE_ITEM_STATUS_USING_WORKFLOW',
          value: 'Users can change item status using a workflow and integrate it to external systems (cannot be unselected)'
        },
        {
          key: 'MSP_2_ORCHESTRATOR_PORT',
          value: 'MSP to Orchestrator Port'
        ...
        {
          key: 'ENTITY_SYSTEM_NAME_INPUT_HELP',
          value: 'Cannot contain spaces. Capitalize first letters. Example: MyEntity'
        },
        {
          key: 'CRITERIA',
          value: 'Criteria'
        ...
        {
          key: 'MANDATORY_AT_WORKFLOW_TRANSITIONS_HELP',
          value: 'The user could save the form when the property is empty, <br/>but will have to fill it before moving to another step.'
        },
        {
          key: 'DELETE_PROPERTY',
          value: 'Delete Property'
        ...
        {
          key: 'YOU_SHOUD_REMOVE_AUTHORIZATION_NODES_BEFORE_DELETING',
          value: 'You should remove authorization nodes referencing this role before deleting it.'
        },
        {
          key: 'TYPE_A_NUMBER',
          value: 'Type a number'
        ...
        {
          key: 'DEFAULT_FORMAT_SETTINGS_HELP_TEXT',
          value: 'Configure the default format of the entity in forms, dashboards and notifications'
        },
        {
          key: 'DELETE_MY_WORK_POLICY_TEXT',
          value: "Worksheets may have already been created using this policy. If you delete it, users won't be able to view them."
        },
        {
          key: 'CREATE_STEP_AFTER',
          value: 'Create step after'
        ...
        {
          key: 'TABLE_LEVEL_AUTH_TIP',
          value: 'For example, all tasks owners will be authorized to edit the requirement form.'
        },
        {
          key: 'ENTER_SQL',
          value: 'Enter a SQL query returning a single value.'
        ...
        {
          key: 'UNIQUE_DB_COLUMN_NAME',
          value: 'This database column name is already in use. Type a different display name or database column name'
        },
        {
          key: 'DISPLAY_IN_RESUME_MAIN_FLOW',
          value: 'Display "Resume main flow" button'
        ...
        {
          key: 'ENTITY_CATEGORY_FOR_NEW_ROW_NOTE',
          value: "Note: The item's workflow rules and actions won't be performed when creating, modifying and deleting it using the table."
        },
        {
          key: 'MILESTONES_TABLE_DUEDATE_PROPERTY',
          value: 'Milestones Table DueDate Date Property'
        ...
        {
          key: 'PRESENT_EDIT_BUTTON_WITH_EDIT_TITLE',
          value: 'present the "Edit" button with the "Edit" title, and also the "Edit Attachment Description" popup form should be "Editable"'
        },
        {
          key: 'PARTICIPANTS',
          value: 'Participants'
        ...
        {
          key: 'AFTER_USER_CHANGES_VALUE_COPY_THIS_TO_OTHER_PROPERTY',
          value: 'After the user changed the value of this property, copy the following values to other properties.'
        },
        {
          key: 'EDIT_WORKFLOW_CONDITION',
          value: 'Edit Workflow Condition'
        ...
        {
          key: 'AN_ILIO_WILL_BE_CREATED_AND_THEN_RUN',
          value: 'An instance-level integration operation will be created (if not already created) and then run.'
        },
        {
          key: 'CHOOSE_A',
          value: 'Choose a'
        ...
        {
          key: 'CONTROL_CANT_BE_VIEWED',
          value: 'The control is currently not viewable. To enable viewing add the "Everyone" role group.'
        },
        {
          key: 'THE_STATE_OF_THE_ENTITY_IN_THIS_STATUS',
          value: 'The state of the entity while in this status'
        ...
        {
          key: 'ATTACHMENT_STOP_RULE_DESCRIPTION',
          value: 'The user will have to attach a file before the item can be progressed'
        },
        {
          key: 'PERSISTENCEBASEDTO_CREATIONUSER_DISPLAY_NAME',
          value: 'Creation User'
        ...
        {
          key: 'STEP_ONE_DESCRIPTION',
          value: 'Step 1 imports entities and SQL objects (views, stored procedures and functions).'
        },
        {
          key: 'OOB_PROPERTIES',
          value: 'Out-Of-the-box properties'
        ...
        {
          key: 'YOU_SHOUD_REMOVE_FORMS_BEFORE_DELETE',
          value: 'You should remove froms and workflows referencing this authorization tree before deleting.'
        },
        {
          key: 'USE_THE_FOLLOWING_NAME_FORMAT_IN_MYWORK_INSTEAD_OF_THE_DEFAULT',
          value: 'Use the following name format in My Work instead of default'
        ...
        {
          key: 'CONDITION_PROPERTY_PLACED_IN_FORM_MESSAGE',
          value: 'You choose a property placed on the form or a formula property. Please notice that the condition will be executed once when the form is displayed, and not after changes are made to the property.'
        },
        {
          key: 'TO_DELETE_THIS_LANE_FIRST_DELETE_STEPS',
          value: 'To delete this lane, first delete all steps in it'
        ...
        {
          key: 'SOME_SETTINGS_HAVE_INVALID_DATA',
          value: 'Some settings have invalid data. Please fix settings marked in red.'
        },
        {
          key: 'PROPERTY_CONDITION',
          value: 'Property Condition'
        ...
        {
          key: 'THE_COMPARISON_WILL_BE_DONE_USING_BOTH_DATE_AND_TIME_COMPONENTS',
          value: 'The comparison will be done using both date and time components'
        },
        {
          key: 'PERCENT_COMPLETE_ONLY',
          value: '% Complete only'
        ...
        {
          key: 'RESTRICT_EDITING_TABLE',
          value: 'Restrict editing and adding rows to the table by adding conditions.'
        },
        {
          key: 'DB_COL_NAME',
          value: 'Database column name'
        ...
        {
          key: 'OVERRIDE_CONDITIONS',
          value: 'Use the following conditions instead of inheriting conditions from'
        },
        {
          key: 'REMAINING_WORK',
          value: 'Remaining Work'
        ...
        {
          key: 'THE_PROPERTY_WILL_BE_INSERTED',
          value: 'The property will be inserted at the end of the controls container'
        },
        {
          key: 'REVERT_TOOLTIP',
          value: 'Return to last saved data'
        ...
        {
          key: 'VIEWING_WORKSHEET_FOR_EXAMPLE',
          value: "For example, a team leader can view his or her team members' worksheets:"
        },
        {
          key: 'REFRESH',
          value: 'Refresh'
        ...
        {
          key: 'CHOOSE_COLUMNS',
          value: 'Choose columns for the browse table, which is displayed after double-clicking the control'
        },
        {
          key: 'ADD_THIS_INIO_TO_AN_ORC',
          value: 'Add this integration operation to an orchestrator. It can be done with an Orchestrator Settings modal panel.'
        },
        {
          key: 'TAB',
          value: 'Tab'
        ...
        {
          key: 'ADD_JAVASCRIPT_XML_ELEMENTS_INSIDE_CUSTOM',
          value: 'Add [Javascript] XML element. It will automatically be placed inside a [ActionsOnTrue]/[Custom] XML element.'
        },
        {
          key: 'DRAG_PROPERTIES',
          value: 'Drag properties onto the form'
        ...
        {
          key: 'ATTACHMENT_STOP_RULE_MESSAGE',
          value: "An attachment of type '{0}' must exist from step '{1}' onwards."
        },
        {
          key: 'DEFAULT_SKIN',
          value: 'Default Skin'
        ...
        {
          key: 'DELETE_ROLE_DESCRIPTION',
          value: "The role's steps will be deleted. You should migrate entities at those workflow steps to other workflow steps."
        },
        {
          key: 'DEFINE',
          value: 'Define'
        ...
        {
          key: 'SEND_EMAIL_NOTIFICATION_WHEN_PROPERTY_VALUE_CHANGED',
          value: "Send the e-mail notification when the property's value was changed"
        },
        {
          key: 'USE_THE_FOLLOWING_LINK_SETTINGS',
          value: 'Use the following link settings, instead of the default setting'
        },
        {
          key: 'PRESENT_NEW_ACTION_ITEM_SECTION',
          value: 'present the "Add New Action Item" section'
        ...
        {
          key: 'USE_THE_FOLLOWING_COLUMNS_SETTINGS',
          value: 'Display the following properties as columns, instead of the default columns'
        },
        {
          key: 'NONE',
          value: 'None'
        ...
        {
          key: 'THE_GROUP_NOT_DISPLAYED_ADD_EVERYONE',
          value: 'The group will not be displayed. To display it, add the Everyone role group.'
        },
        {
          key: 'EVERYONE',
          value: 'Everyone'
        ...
        {
          key: 'RESTRICT_EDITING_SECTION',
          value: 'Restrict editing this section and its child controls by adding conditions'
        },
        {
          key: 'CREATE_AND_NEW',
          value: 'Create & New'
        ...
        {
          key: 'USE_THE_FOLLOWING_FORMAT',
          value: 'Use the following format settings instead of the default settings'
        },
        {
          key: 'UNIQUE_ID',
          value: 'Set property as unique id'
        ...
        {
          key: 'LEAVE_NEW_PROPERTY_WARNING',
          value: 'Are you sure you want to leave this page without saving the property?'
        },
        {
          key: 'PROPERTY_SYSTEM_NAME_INPUT_HELP',
          value: 'Cannot contain spaces. Example: myProperty'
        ...
        {
          key: 'OVERRIDE_WORKSHEET_COLUMNS',
          value: 'Display the following worksheet columns instead of the default columns'
        },
        {
          key: 'APPROVERS',
          value: '%s approvers'
        ...
        {
          key: 'ACTIONS_DEFINED_HERE_WONT_BE_PERFORMED_IF_SKIP_THIS_STEP_TO_DO_DEFINE_RULE',
          value: "Actions defined here won't be performed if the workflow skipped over the step. To do so, define action rule by<br/>opening <b>Workflow Settings</b>, and clicking <b>Action Rules</b>."
        },
        {
          key: 'SET_PROPERTY_VALUE',
          value: 'Set property value'
        ...
        {
          key: 'SAVE_FAILED_MESSAGE',
          value: 'There seems to be a problem saving the changes. Please try again later, or contact your system administrator.'
        },
        {
          key: 'SELECT_AT_LEAST_ONE_OPTION',
          value: 'Select at least one option from the list.'
        ...
        {
          key: 'OLIOS_NOT_ADDED_TO_ANY_WILL_RUN_ON_FIRST',
          value: 'OLIOs not added to any Orchestrator will run on the first Orchestrator.'
        },
        {
          key: 'NEW_WORKFLOW_SIDE_STEP',
          value: 'Add Side Step'
        ...
        {
          key: 'RESTRICT_VIEWING_SECTION',
          value: 'Restrict viewing this section and its child controls by adding conditions'
        },
        {
          key: 'EXPORT_LOCATION',
          value: 'Export Location'
        ...
        {
          key: 'ACTION_ITEMS_CRUD_LEVEL_OF_CONTROL',
          value: 'Use the following conditions to control the level of CRUD for the Action Items.'
        },
        {
          key: 'SESSION_END_MESSAGE_TEXT',
          value: 'Your session is about to expire due to inactivity.'
        ...
        {
          key: 'RESTRICT_VIEWING_TAB',
          value: 'Restrict viewing this tab and its child controls by adding conditions'
        },
        {
          key: 'ADD_ENTITY',
          value: 'Add entity...'
        ...
        {
          key: 'REPORT_ENTITIES_ORDER_SUB_HEADER',
          value: 'Entities will be displayed in this order in quick search and report generator:'
        },
        {
          key: 'EXCLUDE_PROPERTY_FROM_REPORT_GENERATOR',
          value: 'Exclude this property from report generator'
        ...
        {
          key: 'PROGRESS_TO_THIS_STEP_ONLY_IF_CONDITIONS_SATISFIED',
          value: 'Progress to this step only if the following conditions are satisfied. Otherwise, skip to the next step.'
        },
        {
          key: 'TASK',
          value: 'Task'
        ...
        {
          key: 'DELETE_STEP_DESCRIPTION',
          value: 'Entities may be at this workflow step. You should migrate them to another workflow step.'
        },
        {
          key: 'COLUMN',
          value: 'Column'
        ...
        {
          key: 'ATTACHMENTS_ITEMS_CRUD_LEVEL_OF_CONTROL',
          value: 'Use the following conditions to control the level of CRUD for the Attachments Items.'
        },
        {
          key: 'DATA_ENTRY',
          value: 'Data Entry'
        ...
        {
          key: 'INCLUDE_THIS_ENTITY_IN_MY_WORK_POLICIES',
          value: 'Include this entity in My work policies (cannot be unselected)'
        },
        {
          key: 'PROPERTIES_CAN_BE_LINKS',
          value: 'Properties can be links to other forms, or to external pages or systems'
        },
        {
          key: 'FOLLOWING_USERS_ALLOWED_TO_STAR_THE_WORKFLOW',
          value: 'The following users may start the workflow.'
        ...
        {
          key: 'REVERSE_LOOKUP_DISPLAY_NAME_INPUT_HELP',
          value: 'This property will be created on the table entity as a lookup to the form entity.'
        },
        {
          key: 'FOLDER_TIP',
          value: 'A form or workflow element authorized to a folder, is automatically authorized to all nodes inside the folder. For example, Customer Users.'
        },
        {
          key: 'LOOKUP',
          value: 'Lookup'
        ...
        {
          key: 'SESSION_ENDED_MESSAGE',
          value: 'Your session has expired due to inactivity. Please log back in to continue.'
        },
        {
          key: 'DELETE_AUTH_TREE',
          value: 'Delete authorization tree'
        ...
        {
          key: 'YOU_SHOUD_REMOVE_DIALOG_ROLES_BEFORE_DELETING',
          value: 'You should remove Dialog Roles referencing this pProduct before deleting it.'
        },
        {
          key: 'ASSIGNEE',
          value: 'Assignee'
        ...
        {
          key: 'REVERSE_LOOKUP_PRIMARY_SUB_TEXT',
          value: 'This property will be created on the table entity as a lookup to this entity.'
        },
        {
          key: 'DEFAULT_VALUES_OF_ADMIN_TIME_REPORT',
          value: 'Default values of admin time reports'
        ...
        {
          key: 'ADD_ENTITY_TOOLTIP',
          value: 'Add an entity so that users can track time and progress against items of it'
        },
        {
          key: 'COPY_VALUE',
          value: 'Copy Value'
        ...
        {
          key: 'TRIGGERING_CONDITIONS_STEP_DESCRIPTION',
          value: "If this conditions are met, saving or moving the workflow will be prohibited.<BR/>For example: the workflow is about to progress and an attachment type wasn't added."
        },
        {
          key: 'ORDER_BY',
          value: 'Order by'
        ...
        {
          key: 'USE_ROLE_GROUPS_TO_CHECK_DIFFERENT',
          value: 'Use role groups to check different conditions based on the role of the logged-in user.'
        },
        {
          key: 'NEW_HIERARCHY_LEVEL_TIP',
          value: 'Note that the user will be able to create child items as this is a hierarchical entity'
        },
        {
          key: 'ROLE_FILTER',
          value: 'Role filter'
        ...
        {
          key: 'TO_RUN_THIS_OPERATION_CLICK_SETTINGS',
          value: "To run this operation on a specific Orchestrator, click Settings from the Solution Designer home page, <br/>open the Orchestrators section, and then open the Orchestrator's settings window."
        },
        {
          key: 'OF',
          value: 'of'
        ...
        {
          key: 'TO_ENABLE_ROWS_REORDER',
          value: 'To enable rows reordering, check "support rows reorder in entity settings in Entities Editor'
        },
        {
          key: 'DELETE_PROPERTY_WARNING',
          value: 'Are you sure you want to delete %s property?'
        ...
        {
          key: 'STEP_TWO_DESCRIPTION',
          value: 'Step 2 imports solution objects such as workflows, forms and dashboard tabs.'
        },
        {
          key: 'CALENDARS',
          value: 'Calendars'
        ...
        {
          key: 'DELETING_A_FORM_CANNOT_BE_UNDONE',
          value: "Existing items may be depended on this form. If you delete it, users won't be able to view them."
        },
        {
          key: 'MAX_MIN',
          value: 'Max / Min'
        ...
        {
          key: 'TRANSLATE_SOLUTION_OBJECTS_TO_SELECTED_LANGUAGES',
          value: 'Translate solution objects (such as forms and workflows) to selected languages'
        },
        {
          key: 'DELETE_ENTITY',
          value: 'Delete Entity'
        ...
        {
          key: 'MY_WORK_POLICY_INFO',
          value: 'To manage line classifications and admin time categories for this policy, click <b>Administration</b> link in the toolbar, and there click <b>Line Classification</b> or <b>Admin Time Category</b>.'
        },
        {
          key: 'NEW_ACTION_BUTTON',
          value: 'New Action Button'
        ...
        {
          key: 'MESSAGE_STEP_HELP',
          value: "It is recommended to add the item's id in the message. Also consider explaining the cause of the stop, and the steps the user should take to continue"
        },
        {
          key: 'ALL_COLUMN_PROPERTIES',
          value: 'All Column Properties'
        ...
        {
          key: 'ALL_ITEMS_ARE_AVAILABLE_BECAUSE_EVERYONE',
          value: ': All items are available for tracking because the Everyone role group has no conditions.'
        },
        {
          key: 'SQL_FILTER',
          value: 'SQL filter'
        ...
        {
          key: 'CONTROL_VIEWABLE_BECAUSE_EVERYONE',
          value: 'The control is viewable to everyone because the "Everyone" role group has no conditions.'
        },
        {
          key: 'FIND_ENTITY_TOOLTIP',
          value: 'Filter by free text'
        ...
        {
          key: 'CONTROL_EDITABLE_BECAUSE_EVERYONE',
          value: 'The control is editable to everyone because the "Everyone" role group has no conditions.'
        },
        {
          key: 'SET_PROPERTY_MULTI_LOOKUP_OR_TABLE',
          value: 'Set property (Multi lookup or table)'
        ...
        {
          key: 'ALL_ITEMS_BE_INCLUDED_IN_GROUP_BECAUSE_EVERYONE',
          value: ': All items will be included in the group because the Everyone role group has no conditions.'
        },
        {
          key: 'ITEM_WAS_CREATED',
          value: 'Item was created'
        ...
        {
          key: 'ENABLE_MARK_COMPLETE_ACTION_ITEM',
          value: 'enable "Mark Complete", present “Edit” button with “Edit” title and the Edit Action Item popup form should be “Editable”'
        },
        {
          key: 'ENABLE_FOR_EXECUTION_CENTER',
          value: 'Enabled for Execution Center'
        ...
        {
          key: 'DB_TABLE_NAME_INPUT_HELP',
          value: 'Must begin with Cse.Cannot contain spaces. Example: CseMyEntity'
        },
        {
          key: 'ADD_FLOW_STEP_DESCRIPTION',
          value: 'Add a step to the main flow'
        ...
        {
          key: 'MAKE_SURE_NO_WORKFLOW_STEPS_ARE_USING_THE_STATUS',
          value: 'Make sure no workflow steps are using the status before deleting it.'
        },
        {
          key: 'ADD_PROPERTY_TO_THE_INFORMATION_GROUP',
          value: 'Add property to the information group'
        ...
        {
          key: 'RESERVED_SYSTEM_NAME',
          value: 'This is a reserved system name. Type a different display name or system name'
        },
        {
          key: 'DO_YOU_WANT_TO_DELETE_THE_TREE',
          value: 'Do you want to delete the tree?'
        ...
        {
          key: 'ILIOS_NOT_ADDED_TO_ANY_WILL_RUN_ON_FIRST',
          value: 'ILIOs not added to any Orchestrator will run on the first Orchestrator.'
        },
        {
          key: 'ITREETABLE_SEQUENCE_DISPLAY_NAME',
          value: 'Sequence'
        ...
        {
          key: 'IF_SELECTED_USERS_CAN_TRACK_TIME_AND_PROGRES_VIA_MY_WORK',
          value: 'If selected, users can track time spent on items and the progress of the items via My Work.'
        },
        {
          key: 'STANDARD_LICENSE_ROLE',
          value: 'Standard'
        ...
        {
          key: 'ORCHESTRATORS_COMPONENTS_FOR_RUNNING_INTEGRATION',
          value: 'Orchestrators are the components responsible for running integration operations. After installing new orchestrators, add them to this list:'
        },
        {
          key: 'OF',
          value: 'of'
        ...
        {
          key: 'SET_INITIAL_VALUE_OF_TASK_TIME_REPORTS',
          value: 'Set initial value to properties of task time reports (work of task per day)'
        },
        {
          key: 'NEW_ENTITY_TOOLTIP',
          value: 'Create entity'
        ...
        {
          key: 'ADD_OLIOS_TO_RUN_ON_THIS_ORC',
          value: 'Add Orchestrator-level integration operations (OLIO) to run this on specific Orchestrator.'
        },
        {
          key: 'OVERRIDE_DEFAULT_WIDTH',
          value: 'Override default width (px)'
        ...
        {
          key: 'DELETING_APPLICATION_PREFERENCE_WILL_REMOVE_FROM_DB',
          value: 'Deleting an application preference will delete it from the Database.'
        },
        {
          key: 'STATUS_DISPLAY_NAME',
          value: 'STATUS_DISPLAY_NAME'
        ...
        {
          key: 'AFTER_USER_CLICKS_BUTTON_CONFIRMATION_MESSAGE_DISPLAYED',
          value: 'After the user clicks the button, a confirmation message can be displayed.'
        },
        {
          key: 'PROPERTY_REPORTS_HEADER',
          value: 'To include this property in the report generator, select the entity from <b>Entities</b> list, open <b>Settings</b> tab, open <b>Reports</b> section and select <b>Users can create reports based on this entity</b> check box'
        },
        {
          key: 'USE_THE_FOLLOWING_TO_CONFIGURE_CONTROL_USING_XML',
          value: 'Use the following to configure a control using XML.'
        ...
        {
          key: 'THE_ENTITY_WILL_BE_DISPLAYED_CONFIGURATION_ITEMS',
          value: 'The entity will be displayed in Configuration Items section and not in the discipline section'
        },
        {
          key: 'MILESTONES_TABLE_PROPERTY',
          value: 'Milestones Table Property'
        ...
        {
          key: 'SPECIFY_ACTIONS_TO_BE_PERFORMED_FOR_EACH_ITEM_OF_SET',
          value: 'Specify actions to be performed for each of the items in the set'
        },
        {
          key: 'DB_TABLE_NAME',
          value: 'Database table name'
        ...
        {
          key: 'NEW_COLUMN_PROPERTY_HEADER',
          value: 'Create a new column property. The new column will be inserted as the last column in the table or at the end of the last More Information controls container.'
        },
        {
          key: 'STATUSDTO_PREVIOUSFLOWSTEPID_DISPLAY_NAME',
          value: 'Previous Flow Step'
        ...
        {
          key: 'SELECT_TAB_TO_MOVE_SECTION',
          value: 'Select a tab to move the section to. The section will be inserted at the end of the tab.'
        },
        {
          key: 'ADDED',
          value: 'Added %'
        ...
        {
          key: 'CHECK_THAT_ALL_MANDATORY_CONTROLS_HAVE_VALUE_BEFORE_MOVING_WORKFLOW',
          value: 'Check that all mandatory controls have a value before moving the workflow'
        },
        {
          key: 'NOTIFICATION',
          value: 'Notification'
        ...
        {
          key: 'ADD_TRANSITION_HELP',
          value: 'The transition might already exist via "Resume main flow" button, set on a side step.'
        },
        {
          key: 'APPLICATION_PREFERENCE_SYSTEM_NAME_INPUT_HELP',
          value: 'Cannot contain spaces. Capitalize first word letters. Example: MyApplicationPreference'
        },
        {
          key: 'NEED_TO_RELOAD_SETTINGS',
          value: 'Reload Settings'
        ...
        {
          key: 'BUTTON_VIEWABLE_BECAUSE_EVERYONE',
          value: 'The Button is viewable to everyone because the "Everyone" role group has no conditions.'
        },
        {
          key: 'DEFAULT_VALUE',
          value: 'Default Value'
        ...
        {
          key: 'PERSISTENCEBASEDTO_MYWORKTASK_DESCRIPTION',
          value: 'The task will hold My Work information like actual work, % work complete and remaining work.'
        },
        {
          key: 'ACTIONS',
          value: 'Actions'
        ...
        {
          key: 'ADD_SIDE_STEP_DESCRIPTION',
          value: 'Side steps cause the workflow to pause or end. Examples: Awaiting Customer Reply, On Hold, Rejected.'
        },
        {
          key: 'SPECIFY_WHEN_TASK_NAME_HIGHLIGHTED',
          value: 'When the following conditions pass, task name will be highlighted'
        },
        {
          key: 'OPEN_EXISTING_WORKFLOW',
          value: 'Open existing workflow:'
        ...
        {
          key: 'DONE_PLEASE_RELOAD_SETTINGS_IN_ORDER_FOR_CHANGES',
          value: 'Done. Please reload settings in order for the changes to take effect.'
        },
        {
          key: 'NEED_TO_RESTART_MSP_TOOLTIP',
          value: 'To apply the changes to the web site, please restart MSP'
        ...
        {
          key: 'ADD_ILIOS_TO_RUN_ON_THIS_ORC',
          value: 'Add item-level integration operations (ILIO) to run this on specific Orchestrator.'
        },
        {
          key: 'USER_SET_IN_PROPERTY_TITLE',
          value: 'The user will be authorized if he / she is set in a propery.'
        ...
        {
          key: 'UNIQUE_DISPLAY_NAME',
          value: 'This display name is already in use. Type a different display name'
        },
        {
          key: 'TABLE_ENTITY',
          value: 'Table Entity'
        ...
        {
          key: 'THE_GROUP_ALWAYS_DISPLAYED_BECAUSE_EVERYONE',
          value: 'The group will always be displayed because the Everyone role group has no conditions.'
        },
        {
          key: 'ACTION_RULE_TRIGGERING_CONDITIONS_STEP_DESCRIPTION',
          value: 'The rule will be applied only if these conditions are met. <br/>For example, the rule will be applied when the item is cancelled.'
        },
        {
          key: 'ENTITY_CATEGORY',
          value: 'Entity Category'
        ...
        {
          key: 'RUN_THIS_ACTION_ONLY_IF_CONDITIONS_ARE_SATISFIED',
          value: 'Run this action only if the following conditions are satisfied'
        },
        {
          key: 'LOOKUP',
          value: 'Lookup'
        ...
        {
          key: 'USE_THE_FOLLOWING_XML_EXTENSIONS',
          value: 'Use the following to add XML attributes and elements to the form XML definition file.'
        },
        {
          key: 'CONDITIONS_TO_CHECK_BEFORE_RUNNING_THE_ACTION_OPTIONAL',
          value: 'Conditions to check before running the action (optional)'
        ...
        {
          key: 'SELECT_TAB_TO_MOVE',
          value: 'Select a tab to move the control to. The control will be inserted at the end of the tab.'
        },
        {
          key: 'UNIQUE_DB_TABLE_NAME',
          value: 'This database table name is already in use. Type a different display name or database table name'
        },
        {
          key: 'SUFFIX_TOOLIP',
          value: 'You can use $ sign to access the form item object.'
        ...
        {
          key: 'EDIT_BY_NOTIFICATION_TEXT',
          value: "The control's <u>filter</u> is based on one or more properties on the form. <br/>When they are empty, the control will not be editable."
        },
        {
          key: 'ADD_TO_FAVORITES',
          value: 'Add To Favorites'
        ...
        {
          key: 'PROGRESS_COLUMN_HELP',
          value: 'Users manually update this column. <br/>The other column is updated automatically.'
        },
        {
          key: 'RESULTS_FILTER',
          value: 'Results Filter'
        ...
        {
          key: 'TABLE_PROPERTY_SYSTEM_NAME_HELP',
          value: 'Cannot contain spaces. Capitalize first letters. Example: MyEntities'
        },
        {
          key: 'ENTITIES_SAVE_SUCCESS',
          value: 'Your schema changes have been saved successfully'
        ...
        {
          key: 'STOP_RULE_DESCRIPTION',
          value: "Stop rules prohibit making changes to an item if conditions are met.<BR/>For example: Prohibit approving a Design step if a design document wasn't attached."
        },
        {
          key: 'CANNOT_DELETE_THE_CREATE_BUTTON',
          value: 'Cannot delete the Create button'
        ...
        {
          key: 'DEFAULT_SETTINGS_AFFECT',
          value: 'Default settings affect how the property is displayed in other forms, dashboards, notifications, etc.'
        },
        {
          key: 'SELECT_INFORMATION_GROUP',
          value: 'Select information group'
        ...
        {
          key: 'ROW_LEVEL_AUTH_TIP',
          value: "For example, a task's owner will be authorized to edit his / her task row."
        },
        {
          key: 'NEW_CHOICE_OPTION',
          value: 'New Choice Option'
        ...
        {
          key: 'USE_THE_FOLLOWING_INSTRUCTION_LINE_INSTEAD_OF_THE_DEFAULT_SETTING',
          value: 'Use the following instruction line instead of the default settings'
        },
        {
          key: 'WORK_DAYS',
          value: 'Work days:'
        ...
        {
          key: 'OPEN_TASK_LINES',
          value: 'Open task lines for tracking. Can be used to lock tasks for employees at certain workflow steps'
        },
        {
          key: 'WORKSHEET_FORM_TIP',
          value: 'Displayed when clicking Worksheet Details in My Work'
        ...
        {
          key: 'LEAVE_EDITED_ENTITY_WARNING',
          value: 'Are you sure you want to leave this page without saving the changes made on %s ?'
        },
        {
          key: 'DELETE_TASK_STYLE_SUB_TITLE',
          value: 'Are you sure you want to delete the Task Style?'
        ...
        {
          key: 'DELETE_WORKFLOW_TEXT',
          value: "Existing items may be dependant on this workflow. If you delete it, users won't be able to view them."
        },
        {
          key: 'SELECT_IDENTIFIER_PROPERTY',
          value: 'Select identifier property'
        ...
        {
          key: 'STEP_THREE_DESCRIPTION',
          value: 'Step 3 applies the new solution to the web site and refreshes the Solution Designer.'
        },
        {
          key: 'OPEN_ATTENDANCE_LINES',
          value: 'Open attendance lines for tracking'
        ...
        {
          key: 'PRESENT_DROP_FILES_TO_ATTACH',
          value: 'present the "Drop files to attach" or "Browse" or "Paste URL" message and enable the "Drag and Drop" functionality'
        },
        {
          key: 'TREE_ANOTHER_ENTITY_AS_ROOT',
          value: 'Tree (Another entity is the root)'
        ...
        {
          key: 'THIS_ENTITY_WILL_BE_AVAILABLE_TO_ALL_BECAUSE_EVERYONE',
          value: 'This entity will be available to all users because the Everyone role group has no conditions.'
        },
        {
          key: 'ROWS',
          value: 'rows'
        ...
        {
          key: 'ACTIONS_STEP_DESCRIPTION',
          value: 'Specify which actions to perform when rule is triggered.<BR/>For example: cancel all child items.'
        },
        {
          key: 'LET_USERS_SEE_WORKFLOW_STEPS_AND_STEP_CURRENTLY_AT',
          value: 'Let users see the workflow steps and the step the entity is currently at.'
        },
        {
          key: 'OUT_OF_THE_BOX',
          value: 'Out-of-the-Box %'
        ...
        {
          key: 'TABLE_LEVEL_AUTH_TOPIC',
          value: 'The user will be authorized to Form or Workflow elements if he / she is set in a column.'
        },
        {
          key: 'SET_OBJECT_DISPLAY_NAME',
          value: 'Set this {0} display name and description'
        ...
        {
          key: 'NEED_TO_RELOAD_SETTINGS_TOOLTIP',
          value: 'To apply the changes to the web site, click Web Site, open Support menu and click Reload Settings.'
        },
        {
          key: 'NEW',
          value: 'New'
        ...
        {
          key: 'EXISTING_ENTITY_BUTTON_HELPER',
          value: 'For example: creating a table of tasks, risks and other existing entities'
        },
        {
          key: 'FIND_DISCIPLINE_TOOLTIP',
          value: 'Filter by discipline'
        ...
        {
          key: 'SAVE_BUTTON_IS_VISIBLE_TO_EVERYONE_BECAUSE_EVERYONE_ROLE_GROUP',
          value: 'The save button is visible to everyone because the Everyone role group has no conditions'
        },
        {
          key: 'RELOAD_SETTINGS',
          value: 'Reload Settings'
        ...
        {
          key: 'TREE_SUPPORT',
          value: 'Support using this entity in a tree (such as portfolios or strategic goals).'
        },
        {
          key: 'RETURNED_BY_SQL',
          value: 'returned by SQL query'
        ...
        {
          key: 'NO_ITEMS_BE_AVAILABLE_FOR_TRACKING_ADD_EVERYONE',
          value: 'No items will be available for tracking. To enable tracking, add the Everyone role group.'
        },
        {
          key: 'CHOOSE_DISCIPLINE',
          value: 'Choose discipline'
        ...
        {
          key: 'NO_TRANSITION_SELECTED',
          value: 'No transition selected. select transition using from and to links.'
        },
        {
          key: 'OPEN_SETTINGS',
          value: 'Open settings'
        ...
        {
          key: 'MY_WORK_POLICY_ASSIGNMENT_TEXT',
          value: 'Users passing the following conditions will be assigned to this policy.'
        },
        {
          key: 'IS_GREATER_THAN_OR_EQUAL_TO',
          value: 'Is greater than or equal to'
        ...
        {
          key: 'ACTUAL_WORK_AGAINST_ESTIMATED_WORK_HELP',
          value: 'Recommended for reserved hours, where progress is not applicable'
        },
        {
          key: 'PORT',
          value: 'Port'
        ...
        {
          key: 'ACTION_RULE_DESCRIPTION',
          value: "Action rules modify or move item's workflow.<BR/>For example: When item is cancelled, cancel all child items as well."
        },
        {
          key: 'CREATE_NEW_BLANK_WORKFLOW',
          value: 'Create new blank workflow:'
        ...
        {
          key: 'BUTTONS_CURRENTLY_IN_GROUP_WILL_MOVE_TO_FIRST_GROUP',
          value: 'The buttons currently in the group will be moved to the first group.'
        },
        {
          key: 'REGRESS',
          value: 'Regress'
        ...
        {
          key: 'TO_SET_OPERATION_DURATION_THRESHOLDS_CLICK_APPLICATION_PREFERENCES',
          value: 'To set operation duration thresholds, click <b>Application Preferences</b>, and open the <b>Troubleshooting</b> category.'
        },
        {
          key: 'CREATE_STEP_BEFORE',
          value: 'Create step before'
        ...
        {
          key: 'USE_ROLE_GROUP',
          value: 'Use role group to check different conditions based on the role of the logged-in user'
        },
        {
          key: 'EXPORT_ONLY_NAMES_MISSING_TRANSLATION',
          value: 'Export only names missing translation'
        ...
        {
          key: 'BUTTON_CANT_BE_VIEWED',
          value: 'The Button is currently not viewable. To enable viewing add the "Everyone" role group.'
        },
        {
          key: 'CLOSE_SESSION',
          value: 'Close session'
        ...
        {
          key: 'EXAMPLE_INSTRUCTION_LINE',
          value: 'Example: [Impact User : Full Name] should assess work and cost for the requirement'
        },
        {
          key: 'PROPERTIES_DATA_TYPES',
          value: 'Set properties data types'
        ...
        {
          key: 'TO_RESTRICT_VIEWING_THIS_BUTTON_SELECT_TRANSITION_AND_CLICK_ALLOWED_USER',
          value: 'To restrict viewing this button, select the transition and click <b>Allowed users</b> in <b>Transition Picker</b>'
        },
        {
          key: 'SORRY',
          value: 'Sorry...'
        ...
        {
          key: 'MY_WORK_POLICIES_ASSIGNMENT_ORDER_TEXT',
          value: 'Users will be assigned to the first policy which passes the assignment conditions.'
        },
        {
          key: 'TASK_TIME_REPORT_FORM_TIP',
          value: 'Displayed after double-clicking a task day cell in My Work'
        ...
        {
          key: 'DELETE_AUTH_NODE_TEXT',
          value: 'You should remove forms and workflows referencing this authorization node before deleting. All child nodes will be deleted as well.'
        },
        {
          key: 'GENERAL',
          value: 'General'
        ...
        {
          key: 'ROW_LEVEL_AUTH_TOPIC',
          value: 'The user will be authorized only to rows which he / she is set in a column.'
        },
        {
          key: 'ADDED_APPLICATION_PREFERENCES',
          value: 'Added application preferences'
    ...
    },
    {
      ...
      value: [
        {
          key: 'DELETE_ROLE_DESCRIPTION',
          value: 'השלבים של התפקיד יימחקו. אתה צריך להעביר לגופים באותם צעדי עבודה לשלבי עבודה אחרים.'
        },
        {
          key: 'ADD_SIDE_STEP_DESCRIPTION',
          value: 'צעדי סייד לגרום זרימת העבודה כדי להשהות או הסוף. דוגמאות: מחכה לתשובת לקוחות, בהמתנה, נדחה.'
        },
        {
          key: 'IS_LATER_THAN',
          value: 'האם מאוחר מ'
        ...
        {
          key: 'MESSAGE_STEP_HELP',
          value: 'מומלץ להוסיף את המזהה של הפריט בהודעה. שקול גם מסביר את סיבת התחנה, ואת הצעדים המשתמש צריך לנקוט כדי להמשיך'
        },
        {
          key: 'LOOKUP',
          value: 'חיפוש יישות'
        ...
        {
          key: 'FOLDER_TIP',
          value: 'טופס או תהליך עבודה אשר מאושר לתיקייה, מאשר באופן אוטומטי את כל הבנים של התיקייה הזו. לדוגמא, משתמשי לקוח.'
        },
        {
          key: 'AVAILABLE_WORKFLOWS',
          value: 'תהליכי עבודה זמינים'
        ...
        {
          key: 'LEAVE_EDITED_ENTITY_WARNING',
          value: 'האם אתה בטוח שברצונך לעזוב את הדף מבלי לשמור את השינויים ביישות %s?'
        },
        {
          key: 'REMOVE_STEP',
          value: 'מחיקת צעד'
        ...
        {
          key: 'MY_WORK_POLICY_INFO',
          value: 'כדי לנהל סיווגי קו וקטגוריות מנהל זמן למדיניות זו, לחץ על <b> מנהל </ b> בסרגל הכלים, ויש לחץ <b> קו סיווג </ b> או <b> קטגורית זמן Admin </ b>.'
        },
        {
          key: 'TYPE_ID_NUMBER',
          value: 'הקלד מספר מזהה'
        ...
        {
          key: 'TRIGGERING_CONDITIONS_STEP_DESCRIPTION',
          value: 'אם תנאים זו מתקיימים, החיסכון או הזזת העבודה תיאסר <BR/> לדוגמא:. העבודה היא על לקדמת סוג קובץ מצורף לא נוסף.'
        },
        {
          key: 'DB_KEY_COL_NAME',
          value: 'עמודת מפתח'
        ...
        {
          key: 'EDIT_BY_NOTIFICATION_TEXT',
          value: 'הפילטר של השדה מבוסס על אחד או יותר מהשדות על הדף. כאשר אחד מהשדות יהיו ריקים השדה יהיה לא עריך.'
        },
        {
          key: 'WORK',
          value: ''
        ...
        {
          key: 'ADD_ENTITY_TOOLTIP',
          value: 'הוספת ישות כך שמשתמשים יוכלו לעקוב אחר הזמן והתקדמות נגד פריטים של אותו'
        },
        {
          key: 'TO_STEP',
          value: 'אל שלב'
        ...
        {
          key: 'ENTITY_CATEGORY_FOR_NEW_ROW_NOTE',
          value: 'הערה: כללי זרימת העבודה של הפריט ופעולות לא יבוצעו כאשר יצירה, שינוי ומחיקתו באמצעות הטבלה.'
        },
        {
          key: 'BUTTON_VIEWABLE_BECAUSE_EVERYONE',
          value: 'הכפתור הוא יהיה חשוף בפני כולם כי קבוצת התפקיד "כולם" אין תנאים.'
        },
        {
          key: 'IS_PRIOR_TO',
          value: 'האם קודם ל'
        ...
        {
          key: 'TO_RUN_THIS_OPERATION_CLICK_SETTINGS',
          value: 'כדי להפעיל פעולה זו על Orchestrator ספציפי, לחץ על הגדרות מדף הבית פתרון מעצב, <br/> פתח את הקטע Orchestrators, ולאחר מכן לפתוח את חלון ההגדרות של Orchestrator.'
        },
        {
          key: 'PRINT',
          value: 'הדפס'
        ...
        {
          key: 'DELETING_A_FORM_CANNOT_BE_UNDONE',
          value: 'פריטים קיימים עלולים להיות תלויים בטופס זה. מחיקתו תגרום לכך שמשתמשים לא יוכלו לצפות בהם.'
        },
        {
          key: 'SKIP_THIS_CONDITION_IF',
          value: 'דלג על התנאי אם'
        ...
        {
          key: 'DELETE_MY_WORK_POLICY_TEXT',
          value: 'דפי עבודה עשויות נוצרו כבר שימוש במדיניות זו. אם תמחק אותו, משתמשים לא יוכלו להציג אותם.'
        },
        {
          key: 'FILTER_BY_DATA_TYPE_TOOLTIP',
          value: 'חיפוש עפ"י סוג מאפיין'
        ...
        {
          key: 'CONTROL_CANT_BE_EDITED',
          value: 'השדה לא עריך כרגע. בשביל לאפשר עריכה אנא הוסף את תפקיד "כל אחד"'
        },
        {
          key: 'NEW_WORKFLOW_CONDITION',
          value: 'חדשות עבודת מצב'
        ...
        {
          key: 'STEP_ONE_DESCRIPTION',
          value: 'שלב 1 מייבאת גופים ועצמים SQL (תצוגות, משגרות מאוחסנות ופונקציות).'
        },
        {
          key: 'DISPLAY_ONLY_ROWS',
          value: 'הצג שורות שעוברות את המסנים הבאים'
        ...
        {
          key: 'PERSISTENCEBASEDTO_MYWORKTASK_DESCRIPTION',
          value: 'המשימה תכיל מידע "גיליון עבודה" כגון עבודה בפועל, % עבודה שהושלמה ועבודה נותרת.'
        },
        {
          key: 'VIEWED_BY',
          value: 'נצפה על ידי'
        ...
        {
          key: 'USE_ROLE_GROUPS_TO_CHECK_DIFFERENT',
          value: 'השתמש קבוצות התפקיד לבדוק תנאים שונים המבוססים על תפקידו של המשתמש המחובר.'
        },
        {
          key: 'DEFINE',
          value: 'הגדר'
        ...
        {
          key: 'DEFAULT_SETTINGS_AFFECT',
          value: 'הגדרות ברירת מחדל המשפיעות על אופן הצגת המאפיין של טופס, לוח מחוונים, התראות וכדומה'
        },
        {
          key: 'WORKSHEET',
          value: 'גליון עבודה'
        ...
        {
          key: 'TABLE_PROPERTY_SYSTEM_NAME_HELP',
          value: 'השם אינו יכול לכלול רווחים. יש לוודא כי האות הראשונה היא אות גדולה. לדוגמא: MyEntities'
        },
        {
          key: 'EDIT_FORM_OF',
          value: 'עריכת טופס של'
        ...
        {
          key: 'PROGRESS_COLUMN_HELP',
          value: 'משתמשים לעדכן ידנית את הטור הזה. <br/> העמודה האחרת מתעדכנת באופן אוטומטי.'
        },
        {
          key: 'FIND_ENTITY_TOOLTIP',
          value: 'סנן לפי טקסט חופשי'
        ...
        {
          key: 'SELECTED_WORK_DAYS',
          value: 'ימי עבודה נבחרים יהיו פתוחים כברירת מחדל עבור מעקב אחר משתמשים.'
        },
        {
          key: 'CREATE_NEW_ITEM_DIALOG_BOX',
          value: 'צור תיבת הדו-שיח פריט חדש'
        ...
        {
          key: 'MANDATORY_AT_WORKFLOW_TRANSITIONS_HELP',
          value: 'המשתמש יוכל לשמור את הטופס כאשר מאפיין זה ריק, אבל יהיה חייב למלא אותו לפני מעבר שלב.'
        },
        {
          key: 'MILESTONES_TABLE_DESCRIPTION_PROPERTY',
          value: 'אבני דרך שולחן תיאור Textarea נכס'
        ...
        {
          key: 'BUTTON_CANT_BE_VIEWED',
          value: 'הכפתור הוא כרגע לא ניתן לצפות. כדי לאפשר צפייה להוסיף לקבוצת התפקיד "כולם".'
        },
        {
          key: 'AUTHENTICATION',
          value: 'אימות'
        ...
        {
          key: 'ADD_TRANSITION_HELP',
          value: 'יתכן ומעבר השלב קיים כבר ע"י כפתור ה"חזרה לתהליך" שנמצא על מעבר שלב צדדי.'
        },
        {
          key: 'ADD_NEW_REPORT',
          value: 'הוסף דו"ח חדש'
        ...
        {
          key: 'RESTRICT_VIEWING_TAB',
          value: 'להגביל את הצפייה כרטיסייה זו ובקרות הילד שלה על ידי הוספת תנאים'
        },
        {
          key: 'ALL',
          value: 'הכל'
        ...
        {
          key: 'EVERYONE_CAN_MOVE_WORKFLOW_BECAUSE_EVERYONE_ROLE_GROUP',
          value: 'כל אחד יכול להזיז את העבודה בגלל שהקבוצה כולם התפקיד אין תנאים.'
        },
        {
          key: 'SET_INITIAL_VALUE_OF_TASK',
          value: 'ערך ראשוני נקבע מאפיינים של משימות להוסיף גיליונות'
        ...
        {
          key: 'PROPERTY_REPORTS_HEADER',
          value: 'כדי לכלול מאפיין זה במחולל הדוחות, בחר את היישרות מהתפריט, פתח את לשונית ההגדרות וב"דוחות" סמן את התיבה שאומרת "משתמשים יכולים ליצור דוחות בהתבסס על יישות זו"'
        },
        {
          key: 'PORT',
          value: 'נמל'
        ...
        {
          key: 'SELECT_TAB_TO_MOVE',
          value: 'בחר לשונית על מנת להעביר את הפקד אליה. הפקד יתווסף לסוף הלשונית.'
        },
        {
          key: 'CHOOSE_STATUS',
          value: 'בחר מצב'
        ...
        {
          key: 'ACTION_RULE_TRIGGERING_CONDITIONS_STEP_DESCRIPTION',
          value: 'הכלל יחול רק אם התנאים מתקיימים. <br/> לדוגמה, הכלל יחול כאשר הוא ביטל את הפריט.'
        },
        {
          key: 'DO_YOU_WANT_TO_DELETE_THE_TAB',
          value: 'האם מעונינים למחוק את הטאב?'
        ...
        {
          key: 'APPLICATION_PREFERENCE_SYSTEM_NAME_INPUT_HELP',
          value: 'השם אינו יכול לכלול רווחים. יש לוודא כי האות הראשונה היא אות גדולה. לדוגמא: MyApplicationPreference'
        },
        {
          key: 'THIS_ENTITY_WILL_BE_AVAILABLE_TO_ALL_BECAUSE_EVERYONE',
          value: 'ישות זו תהיה זמינה לכל המשתמשים כי קבוצת התפקיד כולם אין תנאים.'
        },
        {
          key: 'TYPE_A_NUMBER',
          value: 'הכנס מספר'
        ...
        {
          key: 'ADD_ILIOS_TO_RUN_ON_THIS_ORC',
          value: 'להוסיף פעולות אינטגרציה ברמת פריט (איליו) כדי להפעיל את זה על Orchestrator הספציפי.'
        },
        {
          key: 'PROPERTY_FILTER',
          value: 'מסנן של מאפיין'
        ...
        {
          key: 'ACTION_RULE_DESCRIPTION',
          value: 'פעולת כללים לשנות או להעביר תהליך עבודה של פריט <BR/> לדוגמא:. כאשר הפריט מתבטל, לבטל את כל פריטי הילד גם כן.'
        },
        {
          key: 'EMPLOYEE_ROLE',
          value: 'עובד'
        ...
        {
          key: 'USERS_CAN_CHANGE_ITEM_STATUS_USING_WORKFLOW',
          value: 'משתמשים יוכלו לשנות את הסטטוס בעזרת תהליך-עבודה ולסנכרן אותו למערכות חיצוניות (לא ניתן לביטול)'
        },
        {
          key: 'SHOW_ROW_HISTORY',
          value: 'היסטוריה בשורת צג'
        ...
        {
          key: 'NEW_COLUMN_PROPERTY_HEADER',
          value: 'יצירת נכס עמודה חדשה. הטור החדש יוכנס כמו הטור האחרון בטבלה או בסוף של המידע שעבר עוד בקרות מיכל.'
        },
        {
          key: 'INTEGRATIONFLAG_SUCCESS',
          value: 'הצלחה'
        ...
        {
          key: 'CUSTOM_LINK_HELP_TEXT',
          value: 'על מנת לכלול את ערך המאפיין בקישור, כתוב @VALUE, הקישור יהיה פעיל כשלמאפיין יהיה ערך.'
        },
        {
          key: 'TABLE_SYSTEM_NAME',
          value: 'שם מערכת שולחן'
        ...
        {
          key: 'ORCHESTRATORS_COMPONENTS_FOR_RUNNING_INTEGRATION',
          value: 'Orchestrators הם הרכיבים אחראים להפעלת פעולות אינטגרציה. לאחר התקנת Orchestrators החדש, להוסיף אותם לרשימה זו:'
        },
        {
          key: 'NEW_PROPERTY_CHANGE_CONDITION',
          value: 'תנאי שינוי מאפיין חדש'
        ...
        {
          key: 'DB_TABLE_NAME_INPUT_HELP',
          value: 'השם צריך להתחיל עם תחילית Cse. השם אינו יכול לכלול רווחים. דוגמא: CseMyEntity'
        },
        {
          key: 'TRANSLATE_MSP_TO_ADDITIONAL_LANGUAGES',
          value: 'תרגם MSP לשפות נוספות'
        ...
        {
          key: 'SAVING_OR_MOVING_PROHIBITED_IF_ITEM_IN_SET_PASSES',
          value: 'שמירה או הזזת העבודה ייאסר אם יש סט פריט אשר <br/> עובר את התנאים'
        },
        {
          key: 'OBSOLETE',
          value: 'מיושן'
        ...
        {
          key: 'STEP_TWO_DESCRIPTION',
          value: 'שלב 2 יבוא חפצי פתרון כגון זרימות עבודה, טפסים וכרטיסיות לוח מחוונים.'
        },
        {
          key: 'ASCENDING',
          value: 'סדר עולה'
        ...
        {
          key: 'VIEWING_WORKSHEET_FOR_EXAMPLE',
          value: 'לדוגמא, מנהיג צוות יכול להציג גיליונות עבודה החברים שלו או קבוצתה:'
        },
        {
          key: 'CONTEXT',
          value: 'הקשר'
        ...
        {
          key: 'ENTITY_SYSTEM_NAME_INPUT_HELP',
          value: 'השם אינו יכול לכלול רווחים. יש לוודא כי האות הראשונה היא אות גדולה. לדוגמא: MyEntity'
        },
        {
          key: 'ANYONE_WHO_CAN_EDIT_THE_TABLE',
          value: 'משתמש שיכול לערוך את הטבלה'
        ...
        {
          key: 'DELETE_STEP_DESCRIPTION',
          value: 'ישויות יכולות להיות בשלב זרימת עבודה זו. עליך להעביר אותם למקום אחר צעד עבודה.'
        },
        {
          key: 'ADD_NEW_SECTION',
          value: 'הוסף איזור חדש'
        ...
        {
          key: 'SET_INITIAL_VALUE_OF_TASK_TIME_REPORTS',
          value: 'ערך ראשוני נקבע מאפיינים של דיווחים בזמן משימה (עבודה של משימה ליום)'
        },
        {
          key: 'NOTE_THE_FIRST_BUTTON_WILL_ALWAYS_BE_DISPLAYED_IN_FULL_SIZE',
          value: 'הערה: על הכפתור הראשון תמיד יוצג בגודל מלא.'
        ...
        {
          key: 'AFTER_USER_CHANGES_VALUE_COPY_THIS_TO_OTHER_PROPERTY',
          value: 'לאחר שהמשתמש שינה את ערך השדה הנוכחי, העתק את הערכים הבאים לשדות אחרים.'
        },
        {
          key: 'DELETE_COLUMN',
          value: 'מחק עמודה'
        ...
        {
          key: 'CONTROL_CANT_BE_VIEWED',
          value: 'השדה לא ניתן לצפייה כרגע. בשביל לאפשר צפייה אנא הוסף את תפקיד "כל אחד"'
        },
        {
          key: 'CHOICE',
          value: 'בחירה'
        ...
        {
          key: 'ILIOS_NOT_ADDED_TO_ANY_WILL_RUN_ON_FIRST',
          value: 'איליוס לא להוסיף לכל Orchestrator יפעל על Orchestrator הראשון.'
        },
        {
          key: 'SELECT',
          value: 'בחר'
        ...
        {
          key: 'ADD_JAVASCRIPT_XML_ELEMENTS_INSIDE_CUSTOM',
          value: 'הוספת אלמנט XML [Javascript]. זה יוצב באופן אוטומטי בתוך אלמנט XML [ActionsOnTrue] / [Custom].'
        },
        {
          key: 'RESUME_MAIN_FLOW_INDICATOR_TOOLTIP',
          value: 'זרימת העבודה יכולה לחדש את הזרימה העיקרית של שלב זה.'
        ...
        {
          key: 'DEFAULT_FORMAT_SETTINGS_HELP_TEXT',
          value: 'הגדרות פורמט ברירת המחדל של היישות עבור טפסים, לוח המחוונים ונוטיפיקציות'
        },
        {
          key: 'OPEN_INFORMATION_PROPERTY_SETTINGS',
          value: 'פתח הגדרות מאפיין מידע'
        ...
        {
          key: 'REMOVE_ENTITY_TEXT',
          value: 'משתמשים לא יוכלו לעקוב אחר הזמן והתקדמות נגד פריטים של ישות זו. נתונים במעקב קיימים לא יימחקו.'
        },
        {
          key: 'STEP',
          value: 'שלב'
        ...
        {
          key: 'TO_SET_OPERATION_DURATION_THRESHOLDS_CLICK_APPLICATION_PREFERENCES',
          value: 'כדי להגדיר ספי משך פעולה, לחץ על <b> העדפות יישום </ b>, ולפתוח את <b> פתרון הבעיות </ b> בקטגוריה.'
        },
        {
          key: 'SUFFIX_TOOLIP',
          value: 'אתה יכול להשתמש $ סימן לגשת לאובייקט פריט הטופס.'
        ...
        {
          key: 'ACTIONS_DEFINED_HERE_WONT_BE_PERFORMED_IF_SKIP_THIS_STEP_TO_DO_DEFINE_RULE',
          value: 'פעולות שהוגדרו כאן לא תבוצענה אם תהליך העבודה פוסחת על הצעד. לשם כך, מגדיר את כלל פעולה על ידי <br/> פתיחה <b> הגדרות Workflow </ b>, ולחיצה על <b> פעולה החוקית </ b>.'
        },
        {
          key: 'ENABLE_FOR_EXECUTION_CENTER',
          value: 'מופעל על מרכז ביצוע'
        ...
        {
          key: 'ACTIONS_STEP_DESCRIPTION',
          value: 'ציינו אילו פעולות לבצע כאשר הכלל מופעל <BR/> לדוגמא:. לבטל את כל פריטי הילד.'
        },
        {
          key: 'CATEGORIZABLE_ENTITYCATEGORY_DISPLAY_NAME',
          value: 'קטגוריה'
        ...
        {
          key: 'OPEN_TASK_LINES',
          value: 'קווי פתח משימה למעקב. ניתן להשתמש בו כדי לנעול משימות לעובדים על צעדי עבודה מסוימים'
        },
        {
          key: 'MODIFIED_LABEL',
          value: 'השתנה'
        ...
        {
          key: 'YOU_SHOUD_REMOVE_FORMS_BEFORE_DELETE',
          value: 'מומלץ להסיר טפסים ותהליכי עבודה המקושרים לעץ האישורים לפני מחיקה.'
        },
        {
          key: 'NEW_AUTH_NODE',
          value: 'צומת אוטוריזציה חדש'
        ...
        {
          key: 'FOLDER_TITLE',
          value: 'המשתמש יקבל אישור אם הוא \\ היא קיבל אישור לאחד מהצמתים בתיקייה.'
        },
        {
          key: 'RESTRICT_VIEWING_CONTROL',
          value: 'להגביל את הצפייה שליטה זו על ידי הוספת תנאים'
        ...
        {
          key: 'CHECK_THAT_ALL_MANDATORY_CONTROLS_HAVE_VALUE_BEFORE_MOVING_WORKFLOW',
          value: 'בדוק שכל שולטת החובה להיות בעל ערך לפני שעברתי את תהליך העבודה'
        },
        {
          key: 'MOVE_COLUMN_TO_MORE_INFO',
          value: 'העבר עמודה למידע נוסף'
        ...
        {
          key: 'THE_BUTTON_RETURNS_THE_FLOW_TO_LAST_STEP',
          value: 'הכפתור מחזיר את זרימת העבודה לשלב הזרימה האחרונה היה ב .. כלול את כפתור צעדי /> <br כמו "מחכה לתשובת לקוחות", "עדכון אימפקט".'
        },
        {
          key: 'DELETE_ORCHESTRATOR',
          value: 'מחק מתזמר'
        ...
        {
          key: 'DELETE_WORKFLOW_TEXT',
          value: 'פריטים קיימים עלולים להיות קשורים לתהליך עבודה זה. מחיקתו עלולה למנוע צפייה בהם.'
        },
        {
          key: 'PROGRESS_TO_THIS_STEP_ONLY_IF_CONDITIONS_SATISFIED',
          value: 'התקדמות לשלב זה רק אם מתקיימים שני התנאים הבאים מתקיימים. אחרת, דלג לשלב הבא.'
        },
        {
          key: 'DO_YOU_WANT_TO_DELETE_THE_MORE_INFO',
          value: 'האם למחוק את המידע הנוסף?'
        ...
        {
          key: 'TO_ENABLE_ROWS_REORDER',
          value: 'כדי לאפשר שורות סידור מחדש, לבדוק "שורות תמיכה לסדר מחדש במסגרות ישות בישויות עורך'
        },
        {
          key: 'CHOOSE_A',
          value: 'בחר'
        ...
        {
          key: 'STOP_RULE_DESCRIPTION',
          value: 'עצור הכללים אוסרים על ביצוע שינויים לפריט אם התנאים מתקיימים <BR/> לדוגמה:. לאסור אישור צעד עיצוב אם מסמך העיצוב לא צורף.'
        },
        {
          key: 'IS_AT_FLOW_STEP',
          value: 'האם בשלב זרימה'
        ...
        {
          key: 'DELETE_AUTH_NODE_TEXT',
          value: 'מומלץ להסיר קישורים לצומת זה מטפסים ותהליכי עבודה לפני המחיקה. כל צומת בן ימחק גם כן.'
        },
        {
          key: 'DO_YOU_WANT_TO_DELETE_THE_TABLE',
          value: 'האם מעונינים למחוק את טבלה?'
        ...
        {
          key: 'PROPERTIES_CAN_BE_LINKS',
          value: 'מאפיינים יכולים להיות קישור לטפסים אחרים, לדפים חיצוניים או מערכות חיצוניות'
        },
        {
          key: 'EDIT_FORMS_HEADER',
          value: 'ערוך את כותרת הטופס'
        ...
        {
          key: 'TO_RESTRICT_VIEWING_THIS_BUTTON_SELECT_TRANSITION_AND_CLICK_ALLOWED_USER',
          value: 'כדי להגביל את צפיית לחצן זה, בחר את המעבר ולחץ על <b> משתמשים מורשים </ b> <b> מעבר פיקר </ b>'
        },
        {
          key: 'TEXT_AREA',
          value: 'טקסט מורחב'
        ...
        {
          key: 'SESSION_ENDED_MESSAGE',
          value: 'חיבור למערכת הסתיים עקב אי-שימוש במערכת. נא בצע כניסה מחדש להמשך עבודה.'
        },
        {
          key: 'DOES_NOT_BEGIN_WITH',
          value: 'לא מתחיל ב'
        ...
        {
          key: 'NO_ITEMS_BE_AVAILABLE_FOR_TRACKING_ADD_EVERYONE',
          value: 'אין פריטים יהיו זמינים למעקב. כדי לאפשר מעקב, להוסיף את קבוצת התפקיד כולם.'
        },
        {
          key: 'EDIT_ITEM_SET_ACTION',
          value: 'ערוך פריט פעולת Set'
        ...
        {
          key: 'USE_ROLE_GROUP',
          value: 'השתמש תפקיד בקבוצה לבדוק תנאים שונים המבוססים על תפקידו של המשתמש המחובר'
        },
        {
          key: 'MAXIMUM_TEXT_SIZE',
          value: 'גודל טקסט מכסימלי'
        ...
        {
          key: 'TABLE_LEVEL_AUTH_TOPIC',
          value: 'המשתמש יקבל אישור לטופס או תהליך עבודה אם הוא \\ היא מוגדר בעמודה.'
        },
        {
          key: 'VALIDATION_FAILED',
          value: 'ולידציה נכשלה'
        ...
        {
          key: 'ADD_OLIOS_TO_RUN_ON_THIS_ORC',
          value: 'להוסיף פעולות אינטגרצית Orchestrator ברמה (אוליו) כדי להפעיל את זה על Orchestrator הספציפי.'
        },
        {
          key: 'ENTER_SQL_QUERY',
          value: 'הכנס שאילתת SQL'
        ...
        {
          key: 'IF_SELECTED_USERS_CAN_TRACK_TIME_AND_PROGRES_VIA_MY_WORK',
          value: 'אם מסומן, משתמשים יכולים לעקוב אחר דיווח שעות והתקדמות של פריטים מיישות זו ב My Work'
        },
        {
          key: 'SOME_SETTINGS_HAVE_INVALID_DATA',
          value: 'חלק מההגדרות לא עברו בדיקת תקינות. נא תקן את ההגדרות באדום'
        ...
        {
          key: 'CONDITION_PROPERTY_PLACED_IN_FORM_MESSAGE',
          value: 'בחרת בשדה שנמצא על הדף או שדה מחושב. אנא שים לב שהתנאי מחושב פעם אחת כאשר הדף נטען ולא אחרי שינויים לשדה.'
        },
        {
          key: 'OPEN_WEEK_DAYS',
          value: 'ימים בשבוע עבודה פתוחים למעקב'
        ...
        {
          key: 'ADD_THIS_INIO_TO_AN_ORC',
          value: 'הוספת מבצע אינטגרציה זו אל Orchestrator. זה יכול להיעשות עם פאנל מודאלי הגדרות Orchestrator.'
        },
        {
          key: 'SAVE_FAILED_MESSAGE',
          value: 'נראה שיש בעיה בשמירת השינויים, אנא נסע שוב מאוחר יותר, או פנה אל מנהל הרשת.'
        },
        {
          key: 'ATTACHMENTS',
          value: 'מסמכים'
        ...
        {
          key: 'SELECT_TAB_TO_MOVE_SECTION',
          value: 'בחר לשונית על מנת להעביר את האיזור אליה. האיזור יתווסף לסוף הלשונית.'
        },
        {
          key: 'ORCHESTRATOR_HOST_NAME',
          value: 'שם המארח Orchestrator'
        ...
        {
          key: 'TRANSITION_SETTINGS_ROLE_GROUP_DESCRIPTION',
          value: 'השתמש בקבוצות תפקידים כדי לקבוע תנאים שונים בהתבסס על המשתמש הנוכחי.'
        },
        {
          key: 'FIND_DISCIPLINE',
          value: 'מצא קטגוריה'
        ...
        {
          key: 'LET_USERS_SEE_WORKFLOW_STEPS_AND_STEP_CURRENTLY_AT',
          value: 'מציג למשתמש את גרף תרשים הזרימה ואת השלב הנוכחי בו נמצאת היישות.'
        },
        {
          key: 'GRAPHICAL_INDICATOR_NAME',
          value: 'שם אינדיקטור גרפי'
  ...
  workflowButtonsRelativePath: '/MSP/resources/images/karambit/workflow_ribbon/half/',
  propertyDataTypes: [
    {
      key: 'Single Line of Text',
      value: '1'
