<template>
  <el-container>
    <el-row type="flex" :gutter="10" class="row-bg" justify="center">
      <el-col :span="6" class="treeview-container">
        <el-row class="treeview-header">
          <el-row type="flex" :gutter="10" justify="center">
            <el-col :span="12">Entities</el-col>
            <el-col :span="12">
              <el-row type="flex" :gutter="5" class="add-container">
                <el-col class="add-text" :span="8" text-right>
                  <a href="#" class="href-button">New</a>
                </el-col>
                <el-col class="add-text" :span="2" text-right>|</el-col>
                <el-col class="add-text" :span="14" text-right>
                  <a href="#" class="href-button">New Virtual</a>
                </el-col>
              </el-row>
            </el-col>
          </el-row>
          <el-row type="flex" :gutter="10">
            <el-col :span="14">
              <el-input v-model="entityKey" placeholder="Find Entity" />
            </el-col>
            <el-col :span="10">
              <el-select v-model="selectedDiscip" placeholder="Find discipline">
                <el-option
